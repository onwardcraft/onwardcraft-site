...
const MARKET = {
  ...
  stats: [
    { value: 'Top 5', label: 'most tornado-prone state, so storm-damage demand spikes fast and hard' },
    { value: '~43%', label: 'of Little Rock residents are Black or African American, so authentic local presence matters', accent: true },
...
const WHY = [
  ...
  },
  {
    ...
    body: "Prices are posted on the site, every report ties back to the leads you actually got, and after the first 90 days you go month-to-month. Don't like the numbers? Cancel. We'd rather earn the work each month than hide behind a contract.",
  },
];
...
export const littleRockLocations = [
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    painPoints: [
      { title: "Page two is where Little Rock leads go to die", body: "Almost nobody clicks past the first page of Google, and they rarely scroll far down it. In Little Rock's home-services market, if you're not in the top handful of results for what you sell, your site is essentially invisible, no matter how many years you've been in business or how good your word-of-mouth reputation is." },
    ...
    faqs: [
      ...
      { q: 'Do you require a long-term contract?', a: "No. We ask for 90 days at the start because that's roughly how long it takes SEO to show real movement in the Little Rock market. After that you're month-to-month, and if the leads aren't there, you walk." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      { title: "Your site is a brochure when it should be booking jobs", body: "A lot of contractor sites just list services and sit there. No clear offer, no obvious next step, no reason to call you over the next result. When a homeowner is dealing with storm damage or a broken AC in 95-degree heat, 'no obvious reason' means they call someone else. We design every page around one job: turning a visitor into a booked lead." },
    ...
    services: [
      ...
      { name: 'Neighborhood-targeted pages', desc: "Pages built around the communities you serve, like Hillcrest, The Heights, Conway, Benton, Bryant, Sherwood, and Maumelle, so you stand out in local searches instead of blending into a generic city page.", featured: true },
    ...
    process: [
      ...
      { name: 'Design', desc: "We mock up a custom, mobile-first layout aimed at booking jobs, then hand it to you to review and adjust before any code gets written. No surprises at launch." },
    ...
    faqs: [
      { q: 'How much does a website cost in Little Rock?', a: "A one-time build runs $2,000 to $8,000 with us, set by how many pages you need and what has to connect to it. The tiers above spell it out. The price is fixed before we start, and the finished site is yours to keep." },
      { q: 'How long does it take to build?', a: "Plan on roughly 2 to 4 weeks for a focused site and 4 to 8 for a bigger custom build. We hand you a firm timeline at the start and check in at each milestone so you're never wondering where things stand." },
      ...
      { q: 'Do I own the website?', a: "Yes, all of it: the site, the domain, the content. Nothing is held hostage and you're never stuck on a platform you can't take with you when you go." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    painPoints: [
      ...
      { title: "It crawls on a phone and loses the visitor", body: "If your site is clunky or slow on mobile, you're losing the majority of your Little Rock visitors before they see your offer. Emergency and storm-damage searches especially happen in the field on a phone. A redesign built mobile-first wins those visitors back." },
    ...
    services: [
      ...
      { name: 'Conversion redesign', desc: "Sharper offers, call buttons placed where a Little Rock homeowner actually taps them, and lead forms built to get filled out. We rebuild for booked work, not just a prettier screenshot." },
      ...
      { name: 'Neighborhood-targeted rebuild', desc: "Rebuilt around the specific communities you serve, like Hillcrest, Conway, Benton, Maumelle, and beyond, so the new site stands out in local searches instead of reading like every other contractor's.", featured: true },
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Little Rock?', a: "A redesign is a one-time project from $2,500 to $9,000, depending on how big the site is and what needs to connect to it. The price is locked before we touch anything, and you own the finished result." },
      ...
      { q: 'How long does a redesign take?', a: "Figure on 3 to 5 weeks for a focused redesign and 5 to 9 for a larger rebuild. You'll have a firm timeline before we start and a status update at every stage along the way." },
