...
const PROOF = {
  ...
  body:
    "We're a young, founder-led shop and won't pretend to a track record we don't have yet. What we can show you is why this works, drawing from Google's and the industry's own research on how people search locally, applied to a storm-and-heat-driven market like Lubbock.",
  stats: [
...
export const lubbockLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    painPoints: [
      { title: 'Three names hold the map after a haboob rolls through', body: "Pull up your own service plus \"near me\" on your phone right now. Three businesses sit pinned to the map at the top. When a dust storm or hail line crosses the High Plains and homeowners start hunting for help, those three are the names that get dialed. Anyone ranked below them might as well not exist in the moment demand peaks. Climbing into that trio for Tech Terrace, Wolfforth, Shallowater, and your other service areas is the highest-payoff thing most Hub City contractors can do." },
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    process: [
      { name: 'Audit and strategy', desc: "We benchmark your current rankings, traffic, and competitors, then build a roadmap around the keywords most likely to drive real Lubbock leads, with storm-season terms prioritized." },
    ...
    faqs: [
      { q: 'How much does SEO cost in Lubbock?', a: "Most Lubbock SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are above, with no hidden fees and no long contract." },
      ...
      { q: 'Do you require a long-term contract?', a: "No. The first 90 days are a fair window for SEO to show real movement in a market this seasonal, then you go month-to-month. Cancel the moment the work stops paying for itself, no penalty and no awkward phone call." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      { title: "It reads like a yard sign, not a booking machine", body: "A lot of Lubbock contractor sites list services and sit there. No clear offer, no obvious next step, nothing that explains why a homeowner should call you over the three other roofers showing up on their phone after the storm. We design every page around one job: turning a visitor into a booked lead, even when that visitor is comparing you to everyone else." },
    ...
    faqs: [
      { q: 'How much does a website cost in Lubbock?', a: "Most contractor websites with us run $2,000 to $8,000 as a one-time build, depending on page count, copywriting, and bilingual needs. Our tiers are above, with fixed price, no surprises, and you own the finished site." },
      { q: 'How long does it take to build?', a: "A focused site runs roughly 2 to 4 weeks. A larger custom build runs 4 to 8. You get a firm date at the start, and we try to have you launched before the spring hail months arrive, since that is when the traffic shows up." },
      ...
      { q: 'Do I own the website?', a: "Every bit of it. The site, the domain, and the words are yours from launch day. We never lock your business inside a platform you cannot take with you when you go." },
