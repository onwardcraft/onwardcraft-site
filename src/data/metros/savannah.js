...
export const savannahLocations = [
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    intro:
      "Most Savannah contractor websites lose leads quietly: slow on a phone, buried call button, no clear offer. Web design done right fixes all of that. We build sites that load fast, look like the specialist you are, and turn Victorian-District-to-Richmond-Hill visitors into booked jobs — and that don't fall over when a storm sends your traffic through the roof.",
    ...
    faqs: [
      ...
      { q: "What do I get in the free quote?", a: "A clear look at what your current site is costing you in lost leads, what a high-converting Savannah site should include, and a fixed-price quote with a timeline. No pressure, just a plan." },
    ],
  },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    intro:
      "Most redesigns go one of two bad ways: the site looks better but converts the same, or it launches and the rankings vanish overnight. We do neither. We redesign Savannah contractor sites for speed and conversions, build them to handle hurricane-season traffic, and migrate with the redirects and SEO care that protect the traffic you already have.",
...
export const savannahCity = {
  ...
  faqs: [
    ...
    { q: 'Where should I start?', a: "Start with a free Savannah audit. We'll look at your website, your rankings, and your Map Pack presence, then tell you the one or two moves that will bring in the most work fastest. No pitch deck, just a plan." },
  ],
};
