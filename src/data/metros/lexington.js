...
export const lexingtonLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    painPoints: [
      { title: 'Three names own the map, and the rest are scrolling past', body: "Type your own trade plus \"near me\" in Lexington and look at the three businesses Google parks at the top. Those three pull the bulk of the calls, whether the search comes from a Kenwick bungalow owner or someone whose gutters just came down in an ice storm. If your name sits below them, most people never tap it, and the quality of your work never gets a chance to matter. For a contractor here, breaking into that trio for the neighborhoods you cover is almost always the move that pays back fastest." },
    ...
    services: [
      ...
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, and mobile load speed. This is the wiring behind the walls that lets every other piece actually show up in Lexington results." },
      ...
      { name: 'AI search readiness', desc: "A lot of \"near me\" research in Lexington now begins inside AI Overviews, ChatGPT, and Perplexity. We shape your content and data so those tools can read your business and name it in their answers.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Fix the foundation', desc: "Google Business Profile and NAP listings come first, because they shift the quickest. For most Lexington contractors the early lift shows up within the first few weeks." },
      ...
      { name: 'Report and expand', desc: "Plain-English reporting built around calls and booked leads, not rankings that look nice on a chart. Once a neighborhood is locked in, we move to the next one on your list." },
    ],
    pricing: {
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    services: [
      { name: 'Technical SEO', desc: "Crawlability, page speed, Core Web Vitals, and schema. These are the behind-the-scenes fixes Google needs handled before it will rank a Lexington contractor for anything." },
      { name: 'On-page optimization', desc: "Every page that earns its keep gets tuned for the exact terms your Lexington customers type, from the titles and headings down to the body copy and internal links." },
      ...
      { name: 'AI search & GEO', desc: "We organize your content so AI Overviews, ChatGPT, and Perplexity pull you into their answers, since a growing slice of Lexington search now starts in those tools rather than a plain results page.", featured: true },
    ],
    ...
    faqs: [
      { q: 'How much does SEO cost in Lexington?', a: "Most Lexington SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are listed above, with no hidden fees and no long contract." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    services: [
      ...
      { name: 'Conversion-focused UX', desc: "Plain offers, call buttons you cannot miss, and lead forms set where people actually fill them in. Every page points the Lexington visitor toward one clear next step." },
      { name: 'Copy that sells', desc: "Words written for the Lexington homeowner who wants a contractor they can trust, not stock filler that would read the same in any city in the country." },
      ...
      { name: 'Neighborhood and county-targeted pages', desc: "Pages built around the specific areas you serve, like Chevy Chase, Nicholasville, Georgetown, and Richmond, so you rank for real local searches instead of blending into a generic state result.", featured: true },
    ...
    process: [
      ...
      { name: 'Design', desc: "We design a custom, mobile-first layout aimed at booking work, and you review and adjust it before we write a single line of code." },
      { name: 'Build and copy', desc: "We build it to load fast and write copy that earns trust from Lexington homeowners, with the call to action sitting front and center on every page." },
      { name: 'Launch', desc: "We push it live with the SEO foundation, tracking, and load speed all set from the first day." },
      { name: 'Support and optimize', desc: "We keep the site quick and up to date, then adjust it based on which pages are actually turning visitors into Lexington calls." },
    ],
    pricing: {
    ...
    faqs: [
      ...
      { q: 'Will my site help me win trust from Lexington homeowners?', a: "That's the entire goal. Lexington residents strongly prefer local contractors, and a site that names the neighborhoods you serve, shows real project photos from the area, and feels genuinely Lexington converts far better than a national template with the city name changed." },
      ...
      { q: 'Do I own the website?', a: "Completely. The site, the domain, and the content are all yours. There are no hostage situations and no locked platform you would have to buy your way out of later." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    services: [
      ...
      { name: 'Conversion redesign', desc: "Sharper offers, smarter call-to-action placement, and lead forms Lexington homeowners actually complete. We rebuild for booked jobs first and good looks second." },
    ...
    process: [
      ...
      { name: 'Launch with SEO care', desc: "We go live with every redirect in place and watch the rankings closely afterward, so your Lexington positions hold and climb rather than slip." },
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Lexington?', a: "Most of our Lexington redesigns land between $2,500 and $9,000 as a one-time project, set by the page count and the integrations involved. The price is fixed, there are no surprises, and the finished site belongs to you." },
      ...
      { q: 'How long does a redesign take?', a: "A focused redesign usually runs about 3 to 5 weeks, while a larger rebuild takes 5 to 9. We hand you a firm timeline at the start and keep you posted at each stage." },
      ...
      { q: 'Will the redesign help me compete in Lexington?', a: "Yes, and that's the point. Lexington homeowners prefer local contractors they can trust, and a redesigned site that names the neighborhoods you serve, shows your real work, and loads fast on a phone earns that trust faster than an outdated generic site ever could." },
