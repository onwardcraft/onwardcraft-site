...
export const knoxvilleLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    painPoints: [
      { title: 'Three rivals are holding the map spots you want', body: "Search your own trade plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks. In Knoxville, where most homeowners make their decision before they even pick up the phone, if you're not one of those three, it almost doesn't matter how good your work is. And when an ice storm rolls through in January and every homeowner in Knox County is searching at once, the contractors already in the top three book their calendars, everyone else gets voicemail." },
    ...
    services: [
      ...
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, and mobile speed dialed in. This is the under-the-hood wiring that decides whether Google even considers ranking you for a Knox County search." },
      ...
      { name: 'AI search readiness', desc: "A growing slice of \"near me\" research starts inside AI Overviews, ChatGPT, and Perplexity. We shape your content and data so those tools can read your Knoxville business and name it in their answers.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Report and expand', desc: "Plain-English reporting built around calls and booked jobs, not ranking screenshots nobody can spend. Once a neighborhood is locked in, we push into the next one across the metro." },
    ],
    pricing: {
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    services: [
      { name: 'Technical SEO', desc: "Crawlability, load speed, Core Web Vitals, and clean schema. We clear the technical hurdles Google checks before it will rank a Knoxville contractor for anything competitive." },
      ...
      { name: 'AI search & GEO', desc: "More East Tennessee homeowners now start a search inside AI Overviews, ChatGPT, or Perplexity. We organize your content so those engines pull your business into their answers.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Report and scale', desc: "Monthly reporting measured in real Knoxville leads. We pour more into the keywords that are paying off and reach into the next suburb or service line from there." },
    ],
    pricing: {
    ...
    faqs: [
      ...
      { q: 'Do you require a long-term contract?', a: "No long contract. We ask for a 90-day start because that's how long Knoxville SEO realistically needs to move, then you're month-to-month. If the work isn't earning its keep, you give notice and go." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    services: [
      ...
      { name: 'Speed & Core Web Vitals', desc: "Tuned to load quickly and clear Google's performance thresholds, which protects your conversions and your Knoxville rankings in one shot." },
      ...
      { name: 'AI-search ready', desc: "Built so AI Overviews and ChatGPT can parse your site and put your Knoxville business forward as more of the search shifts onto those tools.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Design', desc: "We design a custom, mobile-first layout aimed at booking jobs, and you review and shape it before we write a line of code." },
      ...
      { name: 'Launch', desc: "We go live with the SEO foundation, call tracking, and page speed all set from the first day, no loose ends left for later." },
    ...
    faqs: [
      { q: 'How much does a website cost in Knoxville?', a: "Our contractor builds run $2,000 to $8,000 as a one-time project, set by page count and any integrations. The tiers above spell it out, one fixed price, no surprise add-ons, and the finished site belongs to you." },
      { q: 'How long does it take to build?', a: "A focused Knoxville site is roughly 2 to 4 weeks; a larger custom build is 4 to 8. You get a firm timeline at the start and a check-in at each stage so nothing goes quiet on you." },
      ...
      { q: 'Do I own the website?', a: "Yes, all of it, the site files, the domain, and the content. We don't trap your business on a platform you can't take with you if you ever part ways with us." },
      { q: 'Will it work well on phones?', a: "We build mobile-first, since that's where most of your Knoxville traffic shows up. Quick load, big tap-friendly call buttons, and forms a homeowner can finish one-handed from the driveway." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    services: [
      ...
      { name: 'AI-search ready', desc: "Restructured so AI Overviews and ChatGPT can read the rebuilt site and recommend you, as a real share of Knoxville search moves onto those tools.", featured: true },
    ],
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Knoxville?', a: "A redesign with us runs $2,500 to $9,000 as a one-time project, set by the size of the site and any integrations. One fixed price, nothing hidden, and the rebuilt site is yours to keep." },
      { q: 'Will I lose my Google rankings if I redesign?', a: "Not when it's handled with care, which is the only way we do it. We map a 301 redirect for every URL that changes, keep your content and metadata, carry your schema across, and test on staging first. That care matters in Knoxville, where a contractor who's earned ranking on ice storm and storm-damage terms can't afford to drop it." },
      { q: 'How long does a redesign take?', a: "A focused Knoxville redesign is about 3 to 5 weeks; a full rebuild is 5 to 9. You'll have a firm timeline before we start and a status update at every stage." },
