// WILMINGTON — per-metro × per-service local landing pages + city hub.
...
// once and reused across Wilmington's 4 service pages and the hub, because they
// describe the same city. Service-specific blocks are authored per entry.
// PRICING is fixed for cross-city consistency.

// ===========================================================================
// WILMINGTON — shared city blocks
// ===========================================================================
const MARKET = {
  heading: 'Why ranking in Wilmington is a moving target',
  body:
    "Wilmington sits at the center of one of America's most concentrated pockets of money and stability. Delaware is the corporate capital of the country — more than 60% of Fortune 500 companies are incorporated here — and Wilmington itself is a major banking and credit-card hub, home to Bank of America, Chase, Barclays, and M&T, plus the DuPont and Chemours chemical legacy. That means a large, well-paid, settled base of homeowners — lawyers, bankers, executives — who hire professionals and expect professionals. Two things shape demand here. First, almost everyone searches on a phone, usually with \"near me\" attached, and they tap one of the first results without scrolling. Second, this is the Mid-Atlantic. Nor'easters, winter ice, and the remnants of hurricanes hammer the region from fall through spring, and the Christina and Brandywine rivers flood — so demand for roofing, restoration, and HVAC doesn't climb steadily, it spikes. The businesses already ranking are the ones who book that work.",
  pullQuote: 'When the next nor\'easter hits Wilmington, the contractors already ranking are the ones who book the work.',
  donut: {
    title: 'Wilmington at a glance',
    value: 58,
    centerLabel: 'Black/AA (city)',
    legend: [
      { label: 'Black/AA', pct: 58, kind: 'teal' },
      { label: 'Other', pct: 42, kind: 'grey' },
    ],
  },
  seasonTitle: 'When trade demand spikes',
  seasonCaption: "Nor'easter & winter (Nov–Mar) plus storm season (Aug–Oct)",
  seasonalDemand: [
    { m: 'J', v: 88, peak: true }, { m: 'F', v: 84, peak: true }, { m: 'M', v: 72, peak: true }, { m: 'A', v: 48 },
    { m: 'M', v: 42 }, { m: 'J', v: 54 }, { m: 'J', v: 58 },
    { m: 'A', v: 76, peak: true }, { m: 'S', v: 82, peak: true }, { m: 'O', v: 80, peak: true },
    { m: 'N', v: 86, peak: true }, { m: 'D', v: 90, peak: true },
  ],
  stats: [
    { value: '60%+', label: 'of Fortune 500 companies are incorporated in Delaware' },
    { value: '~58%', label: 'of local searches here happen on a phone, usually "near me"', accent: true },
    { value: 'Nov–Mar', label: "nor'easter and winter season, when trade demand spikes" },
    { value: 'Top 3', label: 'Map Pack spots that take most of the clicks' },
  ],
  neighborhoods: [
    'Trinity Vicinity', 'Cool Spring', 'Highlands', 'Greenville', 'Centreville',
    'Hockessin', 'Newark', 'Pike Creek', 'Brandywine Hundred', 'New Castle',
    'Wawaset Park', 'Forty Acres', 'Wilmington Riverfront', 'Chadds Ford', 'Bear',
  ],
};

const AREAS = [
  'Wilmington', 'Newark', 'Hockessin', 'Greenville', 'Centreville', 'Pike Creek',
  'Brandywine Hundred', 'New Castle', 'Bear', 'Claymont', 'Elsmere',
  'Newport', 'Talleyville', 'North Star', 'Chadds Ford',
];
...
const WHY = [
  ...
  {
    title: 'We actually speak Wilmington',
    body: "A settled, well-paid homeowner base, nor'easter and winter storm demand, real neighborhood targeting from Trinity Vicinity to the Brandywine Valley estates. The stuff a national agency can't do by swapping a city name into a template.",
  },
  {
...
const BASE = {
  city: 'Wilmington', state: 'Delaware', stateAbbr: 'DE', metro: 'Wilmington',
...
export const wilmingtonLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...BASE,
    ...
    intro:
      "Wilmington local SEO comes down to one thing: when a homeowner in Trinity Vicinity or Greenville searches your service plus \"near me,\" are you one of the three businesses Google pins to the map? Most people tap one of those three and never scroll. This is a settled, well-paid market with old housing stock and serious storms, so becoming one of those three is the whole game. Here's how you do it.",
    aioQuestion: 'How do Wilmington businesses rank higher in local search?',
    aioAnswer:
      "You rank by getting four things right: a Google Business Profile optimized for the exact services and neighborhoods you want; consistent name, address, and phone listings across the web; a steady stream of real reviews; and local content tied to real Wilmington neighborhoods. Wilmington has a discerning, professional homeowner base and harsh Mid-Atlantic storms, so the winners look established, respond fast, and are already ranking when nor'easter and winter demand spikes.",
    problemHeading: "If your phone is quiet, it's usually one of these three",
    painPoints: [
      { title: 'Your competitors own the three spots on the map', body: "Search your own service plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks. If you're not one of them, it almost doesn't matter how good your work is — most people never see your name. Getting into that top three is usually the single highest-return move a Wilmington business can make." },
      { title: "You're paying for leads you don't own", body: "Angi, Thumbtack, and HomeAdvisor sell the same Wilmington homeowner to four contractors, then bill each of you to fight over them. It's a treadmill. Local SEO builds the opposite: a lead finds you, calls you, and nobody else got it. Over time you stop renting and start owning the pipeline." },
      { title: "You're not ready when the storm hits", body: "When a nor'easter, an ice storm, or river flooding from the Christina and Brandywine hits, demand for roofing, restoration, and HVAC goes vertical overnight, and the contractors already ranking take the calls. If you're invisible on the map when the next one lands, the work goes to whoever Google already trusts. Ranking now is how you catch that wave instead of watching it pass." },
    ],
    servicesHeading: 'What it actually takes to rank you',
    services: [
      { name: 'Google Business Profile', desc: "The biggest lever in the Map Pack. We dial in your categories, services, service area, photos, and posts so Google knows exactly which Wilmington searches you should win." },
      ...
      { name: 'Neighborhood pages', desc: "Real pages for Trinity Vicinity, Greenville, Hockessin, Newark and the rest, so you rank for the neighborhood someone's actually searching, not just \"Wilmington.\"" },
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, mobile speed. The plumbing under the hood that lets everything else rank." },
      { name: 'Local link building', desc: "Mentions and links from Wilmington sources Google trusts — local press, associations, partners. This is what separates page one from page two here." },
      { name: 'Storm-season readiness', desc: "We get your profile, pages, and reviews ranking before nor'easter and winter season so you catch the demand spike instead of scrambling for it after the fact.", featured: true },
    ...
    process: [
      ...
      { name: 'Add local content', desc: "Neighborhood and service-area pages across New Castle County and the Brandywine Valley, plus the on-page work to back them up." },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Local Growth', price: '$1,500', cadence: '/mo', desc: 'For businesses fighting across several Wilmington areas.', features: ['Everything in Local Starter', 'Up to 5 priority keywords', 'Ongoing review generation', 'Neighborhood landing pages', 'On-page and technical SEO'], featured: true },
        { name: 'Local Authority', price: '$2,500', cadence: '/mo', desc: 'For contractors who want to own the map across Wilmington.', features: ['Everything in Local Growth', 'Local link building', 'Storm-season demand targeting', 'Multi-area and service-area pages', 'AI search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does local SEO cost in Wilmington?', a: "Most Wilmington engagements land between $750 and $2,500 a month, depending on how many neighborhoods and keywords you're going after. Our tiers are right above this. No hidden fees, no long contract, and we confirm the exact scope in your free audit." },
      { q: 'How long until I show up in the Map Pack?', a: "Profile improvements can move in a few weeks. The competitive Wilmington keywords usually take 90 to 180 days of steady work, because reviews and citations compound over time. Anyone promising you page one in 30 days in a professional, competitive market like this is selling you something." },
      { q: 'What makes Wilmington local SEO different?', a: "Two things. It's a settled, well-paid market — Delaware is the corporate capital of the country and Wilmington is a major banking hub, so homeowners are discerning and trust signals like reviews and consistent listings carry real weight. And it's the Mid-Atlantic, so trade demand swings hard with nor'easters and winter storms — your ranking has to be in place before the storm, not after." },
      { q: 'How does local SEO help me during storm season?', a: "When a nor'easter, ice storm, or river flooding hits Wilmington, searches for roofing, restoration, and HVAC spike overnight, and the businesses already in the Map Pack take those calls. We get you ranking and reviewed ahead of season so you catch that demand instead of competing for scraps after everyone else is already booked." },
      { q: 'Which areas do you cover?', a: "All of Wilmington and the areas around it — Trinity Vicinity, Cool Spring, Highlands, Greenville, Centreville, Hockessin, plus Newark, Pike Creek, Brandywine Hundred, New Castle and more. We build genuine neighborhood pages instead of one generic Wilmington page, because that's what actually ranks for \"[service] [neighborhood]\" searches." },
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    primaryCta: 'Get my free Wilmington SEO audit',
    intro:
      "Wilmington SEO comes down to one question: when someone searches what you do, are you on page one or page two? Page two might as well be page fifty. We get contractors ranking for the money keywords in a settled, professional, storm-prone market — and we measure it in leads, not vanity traffic.",
    aioQuestion: 'How do Wilmington businesses rank higher on Google?',
    aioAnswer:
      "They rank by fixing the technical foundation of the site, optimizing each page for the exact terms customers search, publishing genuinely useful local content, and earning links from trusted Wilmington sources. In a discerning, competitive Mid-Atlantic market, keeping the site fast on mobile and ranking for storm-driven, seasonal terms are two of the quickest ways to pull ahead.",
    problemHeading: "Three reasons your Wilmington site isn't bringing in work",
    painPoints: [
      ...
      { title: "You're not ranking for the demand that matters", body: "Wilmington demand swings with the season and the storms, and the contractors who rank for those terms ahead of time catch the spike. If your SEO ignores nor'easter-driven and seasonal searches, you're leaving your busiest months on the table." },
    ],
    servicesHeading: 'The SEO work that actually moves rankings',
    services: [
      { name: 'Technical SEO', desc: "Crawlability, site speed, Core Web Vitals, schema, and the under-the-hood fixes Google needs before it will rank you at all." },
      { name: 'On-page optimization', desc: "Every important page tuned for the exact terms your Wilmington customers search — titles, headings, content, and internal links." },
      { name: 'Content that ranks', desc: "Genuinely useful pages and articles that answer what buyers search, earn links, and bring in leads on autopilot." },
      { name: 'Link building', desc: "Authority from real Wilmington and industry sources. In a competitive market, links are often what separate page one from page two." },
      ...
      { name: 'Storm & seasonal SEO', desc: "We rank you for the nor'easter-driven and seasonal searches that drive Wilmington's busiest months, so you're visible before demand spikes, not after.", featured: true },
      { name: 'AI search & GEO', desc: "We structure your content so AI Overviews, ChatGPT, and Perplexity surface and cite you, where a growing share of search now begins.", featured: true },
    ],
    processName: 'How we work: the OnwardCraft SEO method',
    process: [
      { name: 'Audit and strategy', desc: "We benchmark your rankings, traffic, and competitors, then build a roadmap around the keywords most likely to drive real Wilmington leads." },
      ...
      { name: 'Build authority', desc: "Links and citations from trusted Wilmington and industry sources to push competitive keywords onto page one." },
      { name: 'Report and scale', desc: "Monthly reporting tied to leads, then we double down on what's working and expand into the next keyword set." },
    ],
    pricing: {
      heading: 'Transparent Wilmington SEO pricing',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'SEO Starter', price: '$900', cadence: '/mo', desc: 'For a focused site going after its core local keywords.', features: ['Technical SEO fixes', 'On-page optimization', 'Up to 5 target keywords', 'Google Business Profile', 'Monthly lead-tied report'] },
        { name: 'SEO Growth', price: '$1,800', cadence: '/mo', desc: 'For contractors competing across services and neighborhoods.', features: ['Everything in SEO Starter', 'Up to 12 target keywords', 'Monthly content', 'Link building', 'On-page + local SEO'], featured: true },
        { name: 'SEO Authority', price: '$3,000', cadence: '/mo', desc: 'For businesses that want to own Wilmington search.', features: ['Everything in SEO Growth', 'Aggressive content + links', 'Storm & seasonal SEO', 'eCommerce / multi-location', 'AI search / GEO optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does SEO cost in Wilmington?', a: "Most Wilmington SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are above, with no hidden fees and no long contract." },
      { q: 'How long does SEO take to work in Wilmington?', a: "Expect early movement in 2 to 3 months and meaningful results in 4 to 6, faster on low-competition terms and slower on the most competitive Wilmington keywords. SEO compounds, so the gains keep building the longer you run it." },
      ...
      { q: 'Should my Wilmington SEO target storm season?', a: "Yes. When nor'easters, ice storms, or river flooding hit, searches for roofing, restoration, and HVAC spike overnight, and ranking takes months to build — so you have to be in place before the season, not chasing it after. We optimize for those seasonal and storm-driven terms ahead of time so your busiest months land on you." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      ...
      { title: "It's too slow on a phone", body: "Most of your Wilmington visitors are on mobile, and they bounce if your site takes more than a few seconds to load. Slow sites also rank worse. We build fast, so you keep the visitor and the ranking." },
      { title: "It can't handle a storm-season surge", body: "After a nor'easter or major ice storm, contractor sites get hit with a flood of traffic, and the slow ones buckle or bury the call button right when it matters most. We build sites that stay fast and convert under load, so you capture that demand instead of losing it." },
    ],
    servicesHeading: "What's in an OnwardCraft Wilmington website",
    services: [
      ...
      { name: 'Mobile-first build', desc: "Designed for the phone first, because that's where almost all of your Wilmington traffic is. Fast, thumb-friendly, easy to call from." },
    ...
    pricing: {
      heading: 'Transparent Wilmington web design pricing',
    ...
    faqs: [
      { q: 'How much does a website cost in Wilmington?', a: "Most contractor websites with us run $2,000 to $8,000 as a one-time build, depending on page count and integrations. Our tiers are above — fixed price, no surprises, and you own the finished site." },
      { q: 'How long does it take to build?', a: "A focused site takes about 2 to 4 weeks; a larger custom build takes 4 to 8. We give you a firm timeline up front and keep you updated through each stage." },
      { q: 'Will my site handle a storm-season traffic spike?', a: "Yes, and in Wilmington that matters. After a nor'easter or ice storm, contractor sites take a flood of traffic, and the slow ones lose leads right when demand peaks. We build fast and keep the call button obvious, so your site converts under load instead of buckling." },
      { q: 'Will my new site actually rank on Google?', a: "We build every site on a local-SEO foundation — fast load, clean structure, schema, and neighborhood-ready pages. The build gets you ready to rank; pairing it with our SEO service is how you climb the competitive Wilmington terms." },
      { q: 'Do I own the website?', a: "Completely. You own the site, the domain, and the content. No hostage situations, no platforms you can't leave." },
      { q: 'Will it work well on phones?', a: "We design mobile-first, because that's where almost all of your Wilmington traffic comes from. Fast load, easy-to-tap call buttons, and forms built for a thumb." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    problemHeading: "Signs your Wilmington site is overdue for a redesign",
    painPoints: [
      ...
      { title: "It's slow and hard to use on a phone", body: "If your site is clunky or slow on mobile, you're losing the majority of your Wilmington visitors before they ever see your offer. A redesign built mobile-first wins them back." },
    ...
    services: [
      ...
      { name: 'Mobile-first rebuild', desc: "Redesigned around the phone, where almost all your Wilmington traffic lives." },
    ...
    pricing: {
      heading: 'Transparent Wilmington redesign pricing',
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Wilmington?', a: "Most redesigns with us run $2,500 to $9,000 as a one-time project, depending on size and integrations. Fixed price, no surprises, and you own the result." },
      ...
      { q: 'Will the new site handle storm-season traffic?', a: "Yes, and in Wilmington that's a real consideration. After a nor'easter or ice storm, contractor sites take a surge of traffic, and the slow ones lose leads. We rebuild for speed and keep the call to action obvious so the site converts when demand peaks." },
...
export const wilmingtonCity = {
  ...
  services: [
    {
      ...
      blurb: "Get into the top three businesses Google pins to the map when Wilmington searches \"near me.\" The single highest-return move for most local businesses — and how you catch storm-season demand.",
    },
    {
  ...
  faqs: [
    { q: 'What marketing services do you offer in Wilmington?', a: "Four core services for contractors: web design, website redesign, SEO, and local SEO. Most clients combine a high-converting website with SEO and local SEO so they rank, convert, and own their leads — and are ready when storm season hits." },
