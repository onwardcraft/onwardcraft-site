...
const WHY = [
  {
    title: 'We get the Buffalo winter',
    body: "Ice dam calls, burst pipe emergencies, heating system failures, roof stress after a lake-effect dump — we understand the seasonal rhythm of your business here, and everything we build is shaped around how Buffalo homeowners search when they need help fast.",
  },
  {
    title: 'We get you off rented leads',
    body: "The whole goal is a pipeline you own. Not another monthly invoice to a lead broker for homeowners three competitors also bought — which matters even more in a market with tight margins and highly affordable housing.",
  },
  {
    title: 'We actually understand Buffalo neighborhoods',
    body: "The old craftsman in Elmwood Village searches differently than the new build in Amherst or the vacation rental near Niagara Falls. We target tight — neighborhood by neighborhood — instead of just swapping city names into a generic template.",
  },
  {
...
const PROOF = {
  ...
  projection:
    "Here's a rough picture, clearly labelled as a projection and not a result we're claiming: a Buffalo contractor getting around 1,200 local \"near me\" impressions a month across a handful of neighborhoods during the winter season could be missing the majority of that demand simply by sitting off the first page. In a market where the next lake-effect storm can mean a week's worth of emergency bookings, ranking before the season is the entire game. In your free audit, we model the real numbers for your business — your rankings, your search volume, and an honest 90-to-180-day path.",
  disclaimer:
...
export const buffaloLocations = [
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    painPoints: [
      { title: "You're stuck on page two", body: "Almost nobody clicks past the first page of Google, and they rarely scroll far down it. In Buffalo, where homeowners are often searching urgently in the middle of a storm or a January cold snap, being off page one means the work goes to whoever ranked first — not necessarily whoever's best." },
      { title: "You're renting traffic from Google Ads", body: "Ads can work, but the moment your card stops, the leads stop. And in a market with affordable housing prices, the cost-per-click on competitive trade keywords can eat your margin fast. SEO builds an asset you own: rankings that keep producing leads months and years after the work is done, at a fraction of the per-lead cost." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      { title: "It's a brochure, not a lead engine", body: "A lot of contractor sites just list services and sit there. No clear offer, no obvious next step, no reason to call you instead of the next result. In Buffalo, when a homeowner is calling about a burst pipe at 11pm in February, the site that makes it easiest to call wins. We design every page around one job: turning a visitor into a booked lead." },
      { title: "It's too slow on a phone", body: "Most of your Buffalo visitors are on mobile — and in an emergency, they're on a cold phone in a cold house. They bounce if your site takes more than a few seconds to load. Slow sites also rank worse. We build fast, so you keep the visitor and the ranking." },
      { title: "It doesn't speak to Buffalo or its neighborhoods", body: "A homeowner renovating a Victorian in the Delaware District wants to see you know old homes. A family in Amherst wants to see you serve their suburb. A generic contractor site that could be anywhere costs you trust — and trust is what converts a visitor into a call." },
    ],
    servicesHeading: "What's in an OnwardCraft Buffalo website",
    services: [
      { name: 'Custom design', desc: "No cookie-cutter templates. A site designed around your trade, your Buffalo neighborhoods, and the jobs you actually want." },
      { name: 'Mobile-first build', desc: "Designed for the phone first, because that's where almost all of your Buffalo traffic is — and where emergency calls convert or don't." },
      { name: 'Conversion-focused UX', desc: "Clear offers, obvious call buttons, and lead forms placed where they actually get used. Every page has a next step that's easy to take on a phone." },
      { name: 'Copy that sells', desc: "Words that speak to Buffalo homeowners — their winters, their old homes, their neighborhoods — and book the job, not filler text that reads like everyone else." },
      { name: 'Local SEO foundation', desc: "Built from the ground up to rank — clean structure, schema, fast load, and neighborhood-ready pages for the Buffalo metro." },
    ...
    process: [
      { name: 'Discovery and strategy', desc: "We learn your trade, your Buffalo neighborhoods, your best jobs, and what makes your business different — then map the site around booking more of the work you want." },
      { name: 'Design', desc: "We design a custom, mobile-first layout built to convert — you see it and shape it before a line of code is written." },
      { name: 'Build and copy', desc: "We build it fast and write the copy that sells, with the call to action front and center on every page and Buffalo-specific content throughout." },
      { name: 'Launch', desc: "We launch cleanly with the SEO foundation, tracking, and speed dialed in from day one." },
      { name: 'Support and optimize', desc: "We keep it fast and current and tune it based on what's actually converting — including before peak season." },
    ],
    pricing: {
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    painPoints: [
      { title: "It looks dated and costs you trust", body: "Buffalo homeowners are spending real money renovating old Victorians and craftsman homes, and they judge the contractor by their digital presence first. An outdated site signals that maybe your work is outdated too — and sends them to the next result who looks more established." },
      { title: "It's slow and hard to use on a phone", body: "If your site is clunky or slow on mobile, you lose visitors before they even see your services — and those visitors are especially costly to lose during winter emergency searches when homeowners are calling in urgency. A redesign built mobile-first wins them back." },
      { title: "It doesn't convert the visitors you already have", body: "Traffic that doesn't turn into calls is wasted — and in a market like Buffalo where seasonal demand creates concentrated windows of opportunity, every missed conversion matters. We rebuild for the jobs you want, the neighborhoods you serve, and the homeowners who are already searching." },
    ],
    servicesHeading: "What's in an OnwardCraft redesign",
    services: [
      { name: 'Redesign audit', desc: "We pinpoint exactly what's costing you leads and rankings today, so the redesign fixes real problems instead of just changing colors." },
      { name: 'SEO-safe migration', desc: "Redirects, metadata, and schema handled properly so you keep the rankings and traffic you've already earned — including the seasonal positions that matter most." },
      { name: 'Conversion redesign', desc: "Clear offers, better call-to-action placement, and lead forms that actually get used. We design for booked jobs, not just looks — especially for mobile emergency searches." },
      { name: 'Speed overhaul', desc: "We rebuild for fast load and passing Core Web Vitals — better for both conversions and rankings, and critical for urgent searches during bad weather." },
      { name: 'Mobile-first rebuild', desc: "Redesigned around the phone, where almost all your Buffalo traffic lives and where emergency calls are won or lost." },
      { name: 'Brand refresh', desc: "A modern, trustworthy look that matches the quality of your work and the price of the jobs you want to win." },
    ...
    process: [
      { name: 'Audit and plan', desc: "We analyze what's losing you leads and rankings, then map a redesign that fixes it without breaking what already works — and plan around your seasonal calendar if needed." },
      ...
      { name: 'Launch with SEO care', desc: "We launch with redirects in place and monitor closely so rankings hold and improve, not drop — especially important ahead of the winter season." },
