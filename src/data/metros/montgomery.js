// MONTGOMERY — per-metro × per-service local landing pages + city hub.
...
// once and reused across Montgomery's 4 service pages and the hub, because they
// describe the same city. Service-specific blocks are authored per entry.
// PRICING is fixed for cross-city consistency.

// ===========================================================================
// MONTGOMERY — shared city blocks
// ===========================================================================
const MARKET = {
  heading: 'Why ranking in Montgomery is a moving target',
  body:
    "Montgomery is Alabama's capital and the birthplace of the modern civil rights movement — this is the city of the Bus Boycott, Dr. King's Dexter Avenue church, and the Selma-to-Montgomery march. People here carry deep local pride, and it shows in how they buy: homeowners strongly prefer a local business they recognize over an out-of-town name. The metro's economy runs on two anchors — the Hyundai Motor Manufacturing Alabama plant and Maxwell-Gunter Air Force Base with Air University — which means a steady mix of auto workers, engineers, and military families. Those military families PCS in and out constantly, and the moment they arrive they pull out a phone and search Google for a contractor. Two things shape demand here. First, almost everyone searches on a phone with \"near me\" attached and taps one of the first results. Second, central Alabama sits in tornado alley, so when severe storms tear through in spring, demand for roofing and restoration spikes hard and the backlog runs for months. The businesses already ranking are the ones who book that work.",
  pullQuote: 'When the next tornado tears through central Alabama, the contractors already ranking are the ones who book the work.',
  donut: {
    title: 'Who lives in Montgomery',
    value: 60,
    centerLabel: 'Black/AA (city)',
    legend: [
      { label: 'Black/AA', pct: 60, kind: 'teal' },
      { label: 'Other', pct: 40, kind: 'grey' },
    ],
  },
  seasonTitle: 'When trade demand spikes',
  seasonCaption: 'Tornado/storm roofing (Mar–Jun) and Deep South HVAC (Jun–Sep)',
  seasonalDemand: [
    { m: 'J', v: 34 }, { m: 'F', v: 40 }, { m: 'M', v: 72, peak: true }, { m: 'A', v: 88, peak: true },
    { m: 'M', v: 94, peak: true }, { m: 'J', v: 90, peak: true }, { m: 'J', v: 84, peak: true },
    { m: 'A', v: 80, peak: true }, { m: 'S', v: 62 }, { m: 'O', v: 48 },
    { m: 'N', v: 36 }, { m: 'D', v: 32 },
  ],
  stats: [
    { value: '2', label: 'anchor employers — the Hyundai plant and Maxwell-Gunter AFB' },
  ...
  neighborhoods: [
    'Old Cloverdale', 'Garden District', 'Cottage Hill', 'Capitol Heights', 'Pike Road',
    'Prattville', 'Wetumpka', 'Millbrook', 'Deatsville',
  ],
};

const AREAS = [
  'Montgomery', 'Pike Road', 'Prattville', 'Wetumpka', 'Millbrook', 'Deatsville',
  'Old Cloverdale', 'Garden District', 'Cottage Hill', 'Capitol Heights', 'Elmore',
  'Coosada', 'Eclectic', 'Hope Hull', 'Tallassee',
];
...
const WHY = [
  ...
  {
    title: 'We actually speak Montgomery',
    body: "Tornado-alley storm demand, military families who PCS in and search Google day one, deep local pride that favors a recognized local name, real neighborhood targeting from Old Cloverdale to Pike Road. The stuff a national agency can't do by swapping a city name into a template.",
  },
  {
...
const PROOF = {
  ...
  projection:
    "Here's a rough picture, clearly labelled as a projection and not a result we're claiming: say a Montgomery contractor gets around 1,200 local \"near me\" impressions a month. Moving from page-two invisibility into the top three is the difference between a trickle of calls and a booked-out calendar — and after a tornado outbreak, that gap gets even wider. In your free audit, we model the real numbers for your business — your rankings, your search volume, and an honest 90-to-180-day path.",
  disclaimer:
...
const BASE = {
  city: 'Montgomery', state: 'Alabama', stateAbbr: 'AL', metro: 'Montgomery',
...
export const montgomeryLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...BASE,
    ...
    painPoints: [
      { title: 'Your competitors own the three spots on the map', body: "Search your own service plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks. If you're not one of them, it almost doesn't matter how good your work is — most people never see your name. Getting into that top three is usually the single highest-return move a Montgomery business can make." },
      { title: "You're paying for leads you don't own", body: "Angi, Thumbtack, and HomeAdvisor sell the same Montgomery homeowner to four contractors, then bill each of you to fight over them. It's a treadmill. Local SEO builds the opposite: a lead finds you, calls you, and nobody else got it. Over time you stop renting and start owning the pipeline." },
      { title: "You're not ready when the storm hits", body: "When tornadoes and severe storms tear through central Alabama in spring, demand for roofing and restoration goes vertical overnight, and the contractors already ranking take the calls. If you're invisible on the map when the next outbreak lands, the work goes to whoever Google already trusts. Ranking now is how you catch that wave instead of watching it pass." },
    ],
    servicesHeading: 'What it actually takes to rank you',
    services: [
      { name: 'Google Business Profile', desc: "The biggest lever in the Map Pack. We dial in your categories, services, service area, photos, and posts so Google knows exactly which Montgomery searches you should win." },
      ...
      { name: 'Neighborhood pages', desc: "Real pages for Old Cloverdale, Garden District, Pike Road, Prattville and the rest, so you rank for the neighborhood someone's actually searching, not just \"Montgomery.\"" },
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, mobile speed. The plumbing under the hood that lets everything else rank." },
      { name: 'Local link building', desc: "Mentions and links from Montgomery sources Google trusts — local press, associations, partners. This is what separates page one from page two here." },
      { name: 'Storm-season readiness', desc: "We get your profile, pages, and reviews ranking before tornado season so you catch the demand spike instead of scrambling for it after the fact.", featured: true },
    ...
    process: [
      ...
      { name: 'Add local content', desc: "Neighborhood and service-area pages across Montgomery, Prattville, Pike Road, and Wetumpka, plus the on-page work to back them up." },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Local Growth', price: '$1,500', cadence: '/mo', desc: 'For businesses fighting across several Montgomery areas.', features: ['Everything in Local Starter', 'Up to 5 priority keywords', 'Ongoing review generation', 'Neighborhood landing pages', 'On-page and technical SEO'], featured: true },
        { name: 'Local Authority', price: '$2,500', cadence: '/mo', desc: 'For contractors who want to own the map across the Montgomery metro.', features: ['Everything in Local Growth', 'Local link building', 'Storm-season demand targeting', 'Multi-area and service-area pages', 'AI search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does local SEO cost in Montgomery?', a: "Most Montgomery engagements land between $750 and $2,500 a month, depending on how many neighborhoods and keywords you're going after. Our tiers are right above this. No hidden fees, no long contract, and we confirm the exact scope in your free audit." },
      { q: 'How long until I show up in the Map Pack?', a: "Profile improvements can move in a few weeks. The competitive Montgomery keywords usually take 90 to 180 days of steady work, because reviews and citations compound over time. Anyone promising you page one in 30 days is selling you something." },
      { q: 'What makes Montgomery local SEO different?', a: "Two things. Montgomery homeowners carry deep local pride and strongly favor a recognized local business, so trust signals like reviews and consistent listings carry real weight. And central Alabama is in tornado alley, so trade demand swings hard with spring storms — your ranking has to be in place before the outbreak, not after." },
      { q: 'How does local SEO help me during tornado season?', a: "When tornadoes and severe storms hit central Alabama in spring, searches for roofing and restoration spike overnight, and the businesses already in the Map Pack take those calls. We get you ranking and reviewed ahead of season so you catch that demand instead of competing for scraps after everyone else is already booked." },
      { q: 'Which areas do you cover?', a: "All of the Montgomery metro and the areas around it — Old Cloverdale, Garden District, Cottage Hill, Capitol Heights, Pike Road, plus Prattville, Wetumpka, Millbrook, Deatsville and more. We build genuine neighborhood pages instead of one generic Montgomery page, because that's what actually ranks for \"[service] [neighborhood]\" searches." },
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    problemHeading: "Three reasons your Montgomery site isn't bringing in work",
    painPoints: [
      ...
      { title: "You're not ranking for the demand that matters", body: "Montgomery demand swings with the season and the storms — tornadoes in spring, brutal heat in summer — and the contractors who rank for those terms ahead of time catch the spike. If your SEO ignores storm-driven and seasonal searches, you're leaving your busiest months on the table." },
    ],
    servicesHeading: 'The SEO work that actually moves rankings',
    services: [
      { name: 'Technical SEO', desc: "Crawlability, site speed, Core Web Vitals, schema, and the under-the-hood fixes Google needs before it will rank you at all." },
      { name: 'On-page optimization', desc: "Every important page tuned for the exact terms your Montgomery customers search — titles, headings, content, and internal links." },
      { name: 'Content that ranks', desc: "Genuinely useful pages and articles that answer what buyers search, earn links, and bring in leads on autopilot." },
      { name: 'Link building', desc: "Authority from real Montgomery and industry sources. In a market that rewards local trust, links are often what separate page one from page two." },
      ...
      { name: 'Storm & seasonal SEO', desc: "We rank you for the tornado-driven and summer-HVAC searches that drive Montgomery's busiest months, so you're visible before demand spikes, not after.", featured: true },
      { name: 'AI search & GEO', desc: "We structure your content so AI Overviews, ChatGPT, and Perplexity surface and cite you, where a growing share of search now begins.", featured: true },
    ],
    processName: 'How we work: the OnwardCraft SEO method',
    process: [
      { name: 'Audit and strategy', desc: "We benchmark your rankings, traffic, and competitors, then build a roadmap around the keywords most likely to drive real Montgomery leads." },
      ...
      { name: 'Build authority', desc: "Links and citations from trusted Montgomery and industry sources to push competitive keywords onto page one." },
      { name: 'Report and scale', desc: "Monthly reporting tied to leads, then we double down on what's working and expand into the next keyword set." },
    ],
    pricing: {
      heading: 'Transparent Montgomery SEO pricing',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'SEO Starter', price: '$900', cadence: '/mo', desc: 'For a focused site going after its core local keywords.', features: ['Technical SEO fixes', 'On-page optimization', 'Up to 5 target keywords', 'Google Business Profile', 'Monthly lead-tied report'] },
        { name: 'SEO Growth', price: '$1,800', cadence: '/mo', desc: 'For contractors competing across services and neighborhoods.', features: ['Everything in SEO Starter', 'Up to 12 target keywords', 'Monthly content', 'Link building', 'On-page + local SEO'], featured: true },
        { name: 'SEO Authority', price: '$3,000', cadence: '/mo', desc: 'For businesses that want to own Montgomery metro search.', features: ['Everything in SEO Growth', 'Aggressive content + links', 'Storm & seasonal SEO', 'eCommerce / multi-location', 'AI search / GEO optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does SEO cost in Montgomery?', a: "Most Montgomery SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are above, with no hidden fees and no long contract." },
      { q: 'How long does SEO take to work in Montgomery?', a: "Expect early movement in 2 to 3 months and meaningful results in 4 to 6, faster on low-competition terms and slower on the most competitive Montgomery keywords. SEO compounds, so the gains keep building the longer you run it." },
      ...
      { q: 'Should my Montgomery SEO target tornado season?', a: "Yes. When severe storms and tornadoes hit central Alabama in spring, searches for roofing and restoration spike overnight, and ranking takes months to build — so you have to be in place before the season, not chasing it after. We optimize for those seasonal and storm-driven terms ahead of time so your busiest months land on you." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      ...
      { title: "It's too slow on a phone", body: "Most of your Montgomery visitors are on mobile, and they bounce if your site takes more than a few seconds to load. Slow sites also rank worse. We build fast, so you keep the visitor and the ranking." },
      { title: "It can't handle a storm-season surge", body: "After a tornado outbreak tears through central Alabama, contractor sites get hit with a flood of traffic, and the slow ones buckle or bury the call button right when it matters most. We build sites that stay fast and convert under load, so you capture that demand instead of losing it." },
    ],
    servicesHeading: "What's in an OnwardCraft Montgomery website",
    services: [
      ...
      { name: 'Mobile-first build', desc: "Designed for the phone first, because that's where almost all of your Montgomery traffic is. Fast, thumb-friendly, easy to call from." },
    ...
    pricing: {
      heading: 'Transparent Montgomery web design pricing',
    ...
    faqs: [
      { q: 'How much does a website cost in Montgomery?', a: "Most contractor websites with us run $2,000 to $8,000 as a one-time build, depending on page count and integrations. Our tiers are above — fixed price, no surprises, and you own the finished site." },
      { q: 'How long does it take to build?', a: "A focused site takes about 2 to 4 weeks; a larger custom build takes 4 to 8. We give you a firm timeline up front and keep you updated through each stage." },
      { q: 'Will my site handle a storm-season traffic spike?', a: "Yes, and in Montgomery that matters. After a tornado outbreak, contractor sites take a flood of traffic, and the slow ones lose leads right when demand peaks. We build fast and keep the call button obvious, so your site converts under load instead of buckling." },
      { q: 'Will my new site actually rank on Google?', a: "We build every site on a local-SEO foundation — fast load, clean structure, schema, and neighborhood-ready pages. The build gets you ready to rank; pairing it with our SEO service is how you climb the competitive Montgomery terms." },
      { q: 'Do I own the website?', a: "Completely. You own the site, the domain, and the content. No hostage situations, no platforms you can't leave." },
      { q: 'Will it work well on phones?', a: "We design mobile-first, because that's where almost all of your Montgomery traffic comes from. Fast load, easy-to-tap call buttons, and forms built for a thumb." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    problemHeading: "Signs your Montgomery site is overdue for a redesign",
    painPoints: [
      ...
      { title: "It's slow and hard to use on a phone", body: "If your site is clunky or slow on mobile, you're losing the majority of your Montgomery visitors before they ever see your offer. A redesign built mobile-first wins them back." },
    ...
    services: [
      ...
      { name: 'Mobile-first rebuild', desc: "Redesigned around the phone, where almost all your Montgomery traffic lives." },
    ...
    pricing: {
      heading: 'Transparent Montgomery redesign pricing',
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Montgomery?', a: "Most redesigns with us run $2,500 to $9,000 as a one-time project, depending on size and integrations. Fixed price, no surprises, and you own the result." },
      ...
      { q: 'Will the new site handle storm-season traffic?', a: "Yes, and in Montgomery that's a real consideration. After a tornado outbreak, contractor sites take a surge of traffic, and the slow ones lose leads. We rebuild for speed and keep the call to action obvious so the site converts when demand peaks." },
...
export const montgomeryCity = {
  ...
  services: [
    {
      ...
      blurb: "Get into the top three businesses Google pins to the map when Montgomery searches \"near me.\" The single highest-return move for most local businesses — and how you catch storm-season demand.",
    },
    {
  ...
  faqs: [
    { q: 'What marketing services do you offer in Montgomery?', a: "Four core services for contractors: web design, website redesign, SEO, and local SEO. Most clients combine a high-converting website with SEO and local SEO so they rank, convert, and own their leads — and are ready when storm season hits." },
