// TOPEKA — per-metro × per-service local landing pages + city hub.
...
// once and reused across Topeka's 4 service pages and the hub, because they
// describe the same city. Service-specific blocks are authored per entry.
// PRICING is fixed for cross-city consistency.

// ===========================================================================
// TOPEKA — shared city blocks
// ===========================================================================
const MARKET = {
  heading: 'Why ranking in Topeka is a moving target',
  body:
    "Topeka is the capital of Kansas, and that shapes everything about the market. State government is the biggest employer here, which means a stable, recession-resistant base of homeowners who stay put and invest in their houses for the long haul. Add the skilled-trades workforce from Goodyear, Frito-Lay, Mars, and BNSF Railway, and you've got a practical, value-conscious market that strongly prefers local contractors over national brands. Two things shape demand. First, almost everyone searches on a phone, usually with \"near me\" attached, and they tap one of the first results without scrolling. Second, Topeka sits dead center in tornado alley. When spring storms roll through with tornadoes, massive hail, and straight-line winds, demand for roofing and storm restoration doesn't climb — it explodes, and the backlog can run for months. The contractors already ranking are the ones who book that work.",
  pullQuote: 'When the next storm tears through Topeka, the contractors already ranking are the ones who book the work.',
  donut: {
    title: 'Topeka homeowners',
    value: 58,
  ...
  seasonCaption: 'Tornado & hail season (Apr–Jul) plus winter storms (Nov–Mar)',
  seasonalDemand: [
    { m: 'J', v: 56, peak: true }, { m: 'F', v: 52, peak: true }, { m: 'M', v: 66, peak: true }, { m: 'A', v: 84, peak: true },
    { m: 'M', v: 94, peak: true }, { m: 'J', v: 96, peak: true }, { m: 'J', v: 82, peak: true },
    { m: 'A', v: 60 }, { m: 'S', v: 48 }, { m: 'O', v: 52, peak: true },
    { m: 'N', v: 64, peak: true }, { m: 'D', v: 58, peak: true },
  ],
  stats: [
    { value: '~127K', label: 'people in Topeka, the Kansas state capital' },
    { value: '~58%', label: 'of local searches here happen on a phone, usually "near me"', accent: true },
    { value: 'Apr–Jul', label: 'tornado and hail season, when storm-restoration demand spikes' },
    { value: 'Top 3', label: 'Map Pack spots that take most of the clicks' },
  ],
  neighborhoods: [
    'Potwin', 'College Hill', 'Westboro', 'Collins Park', 'Sherwood',
    'Auburn', 'Silver Lake', 'Rossville', 'Tecumseh', 'Lawrence',
    'Oakland', 'Highland Park', 'Croco', 'Soldier Township', 'Mission Township',
  ],
};

const AREAS = [
  'Topeka', 'Lawrence', 'Silver Lake', 'Rossville', 'Auburn', 'Tecumseh',
  'Oakland', 'Highland Park', 'Soldier Township', 'Mission Township',
  'Berryton', 'Meriden', 'Carbondale', 'Perry', 'Grantville',
];
...
const WHY = [
  ...
  {
    title: 'We actually speak Topeka',
    body: "Tornado-alley storm demand, a stable capital-city homeowner base, real neighborhood targeting from Potwin to Westboro. The stuff a national agency can't do by swapping a city name into a template.",
  },
  {
...
const PROOF = {
  ...
  projection:
    "Here's a rough picture, clearly labelled as a projection and not a result we're claiming: say a Topeka contractor gets around 1,200 local \"near me\" impressions a month. Moving from page-two invisibility into the top three is the difference between a trickle of calls and a booked-out calendar — and after a hailstorm, that gap gets even wider. In your free audit, we model the real numbers for your business — your rankings, your search volume, and an honest 90-to-180-day path.",
  disclaimer:
...
const BASE = {
  city: 'Topeka', state: 'Kansas', stateAbbr: 'KS', metro: 'Topeka',
...
export const topekaLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    intro:
      "Topeka local SEO comes down to one thing: when a homeowner in Potwin or College Hill searches your service plus \"near me,\" are you one of the three businesses Google pins to the map? Most people tap one of those three and never scroll. This is a value-conscious capital-city market that prefers local contractors, so becoming one of those three is the whole game. Here's how you do it.",
    aioQuestion: 'How do Topeka businesses rank higher in local search?',
    aioAnswer:
      "You rank by getting four things right: a Google Business Profile optimized for the exact services and neighborhoods you want; consistent name, address, and phone listings across the web; a steady stream of real reviews; and local content tied to real Topeka neighborhoods. Topeka sits in tornado alley and values local contractors, so the winners look established, respond fast, and are already ranking when storm-season demand spikes.",
    problemHeading: "If your phone is quiet, it's usually one of these three",
    painPoints: [
      { title: 'Your competitors own the three spots on the map', body: "Search your own service plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks. If you're not one of them, it almost doesn't matter how good your work is — most people never see your name. Getting into that top three is usually the single highest-return move a Topeka business can make." },
      { title: "You're paying for leads you don't own", body: "Angi, Thumbtack, and HomeAdvisor sell the same Topeka homeowner to four contractors, then bill each of you to fight over them. It's a treadmill. Local SEO builds the opposite: a lead finds you, calls you, and nobody else got it. Over time you stop renting and start owning the pipeline." },
      { title: "You're not ready when the storm hits", body: "When a tornado or a hailstorm tears through Topeka, demand for roofing and restoration goes vertical overnight, and the contractors already ranking take the calls. If you're invisible on the map when the next one lands, the work goes to whoever Google already trusts. Ranking now is how you catch that wave instead of watching it pass." },
    ],
    servicesHeading: 'What it actually takes to rank you',
    services: [
      { name: 'Google Business Profile', desc: "The biggest lever in the Map Pack. We dial in your categories, services, service area, photos, and posts so Google knows exactly which Topeka searches you should win." },
      ...
      { name: 'Neighborhood pages', desc: "Real pages for Potwin, College Hill, Westboro, Silver Lake and the rest, so you rank for the neighborhood someone's actually searching, not just \"Topeka.\"" },
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, mobile speed. The plumbing under the hood that lets everything else rank." },
      { name: 'Local link building', desc: "Mentions and links from Topeka sources Google trusts — local press, associations, partners. This is what separates page one from page two here." },
    ...
    process: [
      ...
      { name: 'Add local content', desc: "Neighborhood and service-area pages across Shawnee County and the surrounding towns, plus the on-page work to back them up." },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Local Growth', price: '$1,500', cadence: '/mo', desc: 'For businesses fighting across several Topeka areas.', features: ['Everything in Local Starter', 'Up to 5 priority keywords', 'Ongoing review generation', 'Neighborhood landing pages', 'On-page and technical SEO'], featured: true },
        { name: 'Local Authority', price: '$2,500', cadence: '/mo', desc: 'For contractors who want to own the map across the Topeka area.', features: ['Everything in Local Growth', 'Local link building', 'Storm-season demand targeting', 'Multi-area and service-area pages', 'AI search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does local SEO cost in Topeka?', a: "Most Topeka engagements land between $750 and $2,500 a month, depending on how many neighborhoods and keywords you're going after. Our tiers are right above this. No hidden fees, no long contract, and we confirm the exact scope in your free audit." },
      { q: 'How long until I show up in the Map Pack?', a: "Profile improvements can move in a few weeks. The competitive Topeka keywords usually take 90 to 180 days of steady work, because reviews and citations compound over time. Anyone promising you page one in 30 days is selling you something." },
      { q: 'What makes Topeka local SEO different?', a: "Two things. It's a value-conscious capital-city market that strongly prefers local contractors, so trust signals like reviews and consistent listings carry real weight. And it sits dead center in tornado alley, so trade demand swings hard with storm season — your ranking has to be in place before the storm, not after." },
      { q: 'How does local SEO help me during storm season?', a: "When a tornado or hailstorm hits Topeka, searches for roofing and restoration spike overnight, and the businesses already in the Map Pack take those calls. We get you ranking and reviewed ahead of season so you catch that demand instead of competing for scraps after everyone else is already booked." },
      { q: 'Which areas do you cover?', a: "All of Topeka and the areas around it — Potwin, College Hill, Westboro, Collins Park, Sherwood, Oakland, Highland Park, plus Lawrence, Silver Lake, Rossville, Auburn, Tecumseh and more. We build genuine neighborhood pages instead of one generic Topeka page, because that's what actually ranks for \"[service] [neighborhood]\" searches." },
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    primaryCta: 'Get my free Topeka SEO audit',
    intro:
      "Topeka SEO comes down to one question: when someone searches what you do, are you on page one or page two? Page two might as well be page fifty. We get contractors ranking for the money keywords in a value-conscious, storm-prone market — and we measure it in leads, not vanity traffic.",
    aioQuestion: 'How do Topeka businesses rank higher on Google?',
    aioAnswer:
      "They rank by fixing the technical foundation of the site, optimizing each page for the exact terms customers search, publishing genuinely useful local content, and earning links from trusted Topeka sources. In a tornado-alley market where homeowners prefer local contractors, keeping the site fast on mobile and ranking for storm-driven, seasonal terms are two of the quickest ways to pull ahead.",
    problemHeading: "Three reasons your Topeka site isn't bringing in work",
    painPoints: [
      ...
      { title: "You're not ranking for the demand that matters", body: "Topeka demand swings with the season and the storms, and the contractors who rank for those terms ahead of time catch the spike. If your SEO ignores tornado- and hail-driven searches plus deep-winter terms, you're leaving your busiest months on the table." },
    ],
    servicesHeading: 'The SEO work that actually moves rankings',
    services: [
      { name: 'Technical SEO', desc: "Crawlability, site speed, Core Web Vitals, schema, and the under-the-hood fixes Google needs before it will rank you at all." },
      { name: 'On-page optimization', desc: "Every important page tuned for the exact terms your Topeka customers search — titles, headings, content, and internal links." },
      { name: 'Content that ranks', desc: "Genuinely useful pages and articles that answer what buyers search, earn links, and bring in leads on autopilot." },
      { name: 'Link building', desc: "Authority from real Topeka and industry sources. In a competitive market, links are often what separate page one from page two." },
      ...
      { name: 'Storm & seasonal SEO', desc: "We rank you for the tornado-, hail-, and winter-driven searches that drive Topeka's busiest months, so you're visible before demand spikes, not after.", featured: true },
      { name: 'AI search & GEO', desc: "We structure your content so AI Overviews, ChatGPT, and Perplexity surface and cite you, where a growing share of search now begins.", featured: true },
    ],
    processName: 'How we work: the OnwardCraft SEO method',
    process: [
      { name: 'Audit and strategy', desc: "We benchmark your rankings, traffic, and competitors, then build a roadmap around the keywords most likely to drive real Topeka leads." },
      ...
      { name: 'Build authority', desc: "Links and citations from trusted Topeka and industry sources to push competitive keywords onto page one." },
      { name: 'Report and scale', desc: "Monthly reporting tied to leads, then we double down on what's working and expand into the next keyword set." },
    ],
    pricing: {
      heading: 'Transparent Topeka SEO pricing',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'SEO Starter', price: '$900', cadence: '/mo', desc: 'For a focused site going after its core local keywords.', features: ['Technical SEO fixes', 'On-page optimization', 'Up to 5 target keywords', 'Google Business Profile', 'Monthly lead-tied report'] },
        { name: 'SEO Growth', price: '$1,800', cadence: '/mo', desc: 'For contractors competing across services and neighborhoods.', features: ['Everything in SEO Starter', 'Up to 12 target keywords', 'Monthly content', 'Link building', 'On-page + local SEO'], featured: true },
        { name: 'SEO Authority', price: '$3,000', cadence: '/mo', desc: 'For businesses that want to own Topeka search.', features: ['Everything in SEO Growth', 'Aggressive content + links', 'Storm & seasonal SEO', 'eCommerce / multi-location', 'AI search / GEO optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does SEO cost in Topeka?', a: "Most Topeka SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are above, with no hidden fees and no long contract." },
      { q: 'How long does SEO take to work in Topeka?', a: "Expect early movement in 2 to 3 months and meaningful results in 4 to 6, faster on low-competition terms and slower on the most competitive Topeka keywords. SEO compounds, so the gains keep building the longer you run it." },
      ...
      { q: 'Should my Topeka SEO target storm season?', a: "Yes. When tornadoes and hailstorms hit, searches for roofing and restoration spike overnight, and ranking takes months to build — so you have to be in place before the season, not chasing it after. We optimize for those seasonal and storm-driven terms ahead of time so your busiest months land on you." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      ...
      { title: "It's too slow on a phone", body: "Most of your Topeka visitors are on mobile, and they bounce if your site takes more than a few seconds to load. Slow sites also rank worse. We build fast, so you keep the visitor and the ranking." },
      { title: "It can't handle a storm-season surge", body: "After a tornado or a big hailstorm, contractor sites get hit with a flood of traffic, and the slow ones buckle or bury the call button right when it matters most. We build sites that stay fast and convert under load, so you capture that demand instead of losing it." },
    ],
    servicesHeading: "What's in an OnwardCraft Topeka website",
    services: [
      ...
      { name: 'Mobile-first build', desc: "Designed for the phone first, because that's where almost all of your Topeka traffic is. Fast, thumb-friendly, easy to call from." },
    ...
    pricing: {
      heading: 'Transparent Topeka web design pricing',
    ...
    faqs: [
      { q: 'How much does a website cost in Topeka?', a: "Most contractor websites with us run $2,000 to $8,000 as a one-time build, depending on page count and integrations. Our tiers are above — fixed price, no surprises, and you own the finished site." },
      { q: 'How long does it take to build?', a: "A focused site takes about 2 to 4 weeks; a larger custom build takes 4 to 8. We give you a firm timeline up front and keep you updated through each stage." },
      { q: 'Will my site handle a storm-season traffic spike?', a: "Yes, and in Topeka that matters. After a tornado or hailstorm, contractor sites take a flood of traffic, and the slow ones lose leads right when demand peaks. We build fast and keep the call button obvious, so your site converts under load instead of buckling." },
      { q: 'Will my new site actually rank on Google?', a: "We build every site on a local-SEO foundation — fast load, clean structure, schema, and neighborhood-ready pages. The build gets you ready to rank; pairing it with our SEO service is how you climb the competitive Topeka terms." },
      { q: 'Do I own the website?', a: "Completely. You own the site, the domain, and the content. No hostage situations, no platforms you can't leave." },
      { q: 'Will it work well on phones?', a: "We design mobile-first, because that's where almost all of your Topeka traffic comes from. Fast load, easy-to-tap call buttons, and forms built for a thumb." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    problemHeading: "Signs your Topeka site is overdue for a redesign",
    painPoints: [
      ...
      { title: "It's slow and hard to use on a phone", body: "If your site is clunky or slow on mobile, you're losing the majority of your Topeka visitors before they ever see your offer. A redesign built mobile-first wins them back." },
    ...
    services: [
      ...
      { name: 'Mobile-first rebuild', desc: "Redesigned around the phone, where almost all your Topeka traffic lives." },
    ...
    pricing: {
      heading: 'Transparent Topeka redesign pricing',
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Topeka?', a: "Most redesigns with us run $2,500 to $9,000 as a one-time project, depending on size and integrations. Fixed price, no surprises, and you own the result." },
      ...
      { q: 'Will the new site handle storm-season traffic?', a: "Yes, and in Topeka that's a real consideration. After a tornado or hailstorm, contractor sites take a surge of traffic, and the slow ones lose leads. We rebuild for speed and keep the call to action obvious so the site converts when demand peaks." },
...
export const topekaCity = {
  ...
  services: [
    {
      ...
      blurb: "Get into the top three businesses Google pins to the map when Topeka searches \"near me.\" The single highest-return move for most local businesses — and how you catch storm-season demand.",
    },
    {
  ...
  faqs: [
    { q: 'What marketing services do you offer in Topeka?', a: "Four core services for contractors: web design, website redesign, SEO, and local SEO. Most clients combine a high-converting website with SEO and local SEO so they rank, convert, and own their leads — and are ready when storm season hits." },
