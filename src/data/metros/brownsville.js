...
const PROOF = {
  ...
  projection:
    "Here's a rough picture, clearly labelled as a projection and not a result we're claiming: say a Brownsville contractor gets around 1,200 local \"near me\" impressions a month across a handful of neighborhoods. Moving from page-two invisibility into the top three is the difference between a trickle of calls and a booked-out calendar. In a bilingual market with almost no Spanish-optimized competition, that gap is wide open. In your free audit, we model the real numbers for your business: your rankings, your search volume, and an honest 90-to-180-day path.",
  disclaimer:
...
export const brownsvilleLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    painPoints: [
      { title: 'Three rivals own the only map spots in the Valley', body: "Pull up your own service plus \"near me,\" or the Spanish version of it, right now. The three businesses Google pins to the map take the overwhelming share of the calls, whether the searcher is in Brownsville, San Benito, or out toward Los Fresnos. If your name is not one of those three, the quality of your work barely matters, because most homeowners never scroll far enough to find you. Landing in that top three is usually the single highest-return move a Valley contractor can make." },
