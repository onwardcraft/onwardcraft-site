// ROCKFORD — per-metro × per-service local landing pages + city hub.
...
// once and reused across Rockford's 4 service pages and the hub, because they
// describe the same city. Service-specific blocks are authored per entry.
// PRICING is fixed for cross-city consistency.

// ===========================================================================
// ROCKFORD — shared city blocks
// ===========================================================================
const MARKET = {
  heading: 'Why ranking in Rockford is a moving target',
  body:
    "Rockford is Illinois' third-largest city — a historic manufacturing powerhouse that once called itself the Machine Tool Capital and is now a serious aerospace cluster, with Collins Aerospace, Woodward, AAR, and one of the fastest-growing cargo airports in the country at Chicago Rockford International. The homeowners here are practical and value-conscious: skilled-trades families, engineers, and renovators fixing up affordable older homes in a market that's clawing its way back from industrial decline. Two things shape demand. First, almost everyone searches on a phone, usually with \"near me\" attached, and they call one of the first results without scrolling. Second, northern Illinois weather is brutal and seasonal — heavy snow and ice from November through March, then a hard swing into tornado season and Rock River flooding in spring. When a freeze cracks pipes or an EF4 like the one that hit Fairdale rolls through, demand for roofing, restoration, and HVAC doesn't climb — it explodes. The contractors already ranking are the ones who book that work.",
  pullQuote: 'When the next freeze or storm hits Rockford, the contractors already ranking are the ones who book the work.',
  donut: {
    title: 'How Rockford searches',
    value: 17,
  ...
  seasonCaption: 'Winter snow/ice (Nov–Mar) and spring storms/flooding (Mar–Jun)',
  seasonalDemand: [
    { m: 'J', v: 88, peak: true }, { m: 'F', v: 84, peak: true }, { m: 'M', v: 78, peak: true },
    { m: 'A', v: 72, peak: true }, { m: 'M', v: 80, peak: true }, { m: 'J', v: 74, peak: true },
    { m: 'J', v: 58 }, { m: 'A', v: 54 }, { m: 'S', v: 44 }, { m: 'O', v: 52 },
    { m: 'N', v: 70, peak: true }, { m: 'D', v: 86, peak: true },
  ],
  stats: [
    { value: '3rd', label: "largest city in Illinois — a major aerospace and manufacturing hub" },
    { value: '~58%', label: 'of local searches here happen on a phone, usually "near me"', accent: true },
    { value: 'Nov–Mar', label: 'brutal northern Illinois winter, when freeze damage spikes demand' },
    { value: 'Top 3', label: 'Map Pack spots that take most of the clicks' },
  ],
  neighborhoods: [
    'Edgewater', "Churchill's Grove", 'Signal Hill', 'Midtown', 'Cherry Valley',
    'Loves Park', 'Machesney Park', 'Roscoe', 'Belvidere', 'Rockton',
  ],
};

const AREAS = [
  'Rockford', 'Loves Park', 'Machesney Park', 'Cherry Valley', 'Belvidere',
  'Roscoe', 'Rockton', 'Winnebago', 'Byron', 'Rochelle',
  'Freeport', 'Poplar Grove', 'South Beloit', 'New Milford', 'Pecatonica',
];
...
const WHY = [
  {
    ...
    body: "Roofing, HVAC, plumbing, solar, electrical, restoration, GCs. We understand freeze damage, emergency calls, storm season, and insurance work, so everything we build is shaped around how your customers really search.",
  },
  {
  ...
  {
    title: 'We actually speak Rockford',
    body: "Brutal northern Illinois winters, spring tornadoes and Rock River flooding, a value-conscious buy-local culture, real neighborhood targeting from Edgewater to Machesney Park. The stuff a national agency can't do by swapping a city name into a template.",
  },
  {
...
const PROOF = {
  ...
  projection:
    "Here's a rough picture, clearly labelled as a projection and not a result we're claiming: say a Rockford contractor gets around 1,500 local \"near me\" impressions a month. Moving from page-two invisibility into the top three is the difference between a trickle of calls and a booked-out calendar — and after a hard freeze or a spring storm, that gap gets even wider. In your free audit, we model the real numbers for your business — your rankings, your search volume, and an honest 90-to-180-day path.",
  disclaimer:
...
const BASE = {
  city: 'Rockford', state: 'Illinois', stateAbbr: 'IL', metro: 'Rockford',
...
export const rockfordLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...BASE,
    ...
    painPoints: [
      { title: 'Your competitors own the three spots on the map', body: "Search your own service plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks. If you're not one of them, it almost doesn't matter how good your work is — most people never see your name. Getting into that top three is usually the single highest-return move a Rockford business can make." },
      { title: "You're paying for leads you don't own", body: "Angi, Thumbtack, and HomeAdvisor sell the same Rockford homeowner to four contractors, then bill each of you to fight over them. It's a treadmill. Local SEO builds the opposite: a lead finds you, calls you, and nobody else got it. Over time you stop renting and start owning the pipeline." },
      { title: "You're not ready when winter or a storm hits", body: "When a deep freeze cracks pipes or a spring tornado like the one near Fairdale rolls through, demand for roofing, restoration, and HVAC goes vertical overnight, and the contractors already ranking take the calls. If you're invisible on the map when the next one lands, the work goes to whoever Google already trusts. Ranking now is how you catch that wave instead of watching it pass." },
    ],
    servicesHeading: 'What it actually takes to rank you',
    services: [
      { name: 'Google Business Profile', desc: "The biggest lever in the Map Pack. We dial in your categories, services, service area, photos, and posts so Google knows exactly which Rockford searches you should win." },
      ...
      { name: 'Neighborhood pages', desc: "Real pages for Edgewater, Cherry Valley, Loves Park, Machesney Park and the rest, so you rank for the neighborhood someone's actually searching, not just \"Rockford.\"" },
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, mobile speed. The plumbing under the hood that lets everything else rank." },
      { name: 'Local link building', desc: "Mentions and links from Rockford sources Google trusts — local press, associations, partners. This is what separates page one from page two here." },
      { name: 'Season-readiness', desc: "We get your profile, pages, and reviews ranking before winter and storm season so you catch the demand spike instead of scrambling for it after the fact.", featured: true },
    ...
    process: [
      ...
      { name: 'Add local content', desc: "Neighborhood and service-area pages across Winnebago and Boone counties, plus the on-page work to back them up." },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Local Growth', price: '$1,500', cadence: '/mo', desc: 'For businesses fighting across several Rockford areas.', features: ['Everything in Local Starter', 'Up to 5 priority keywords', 'Ongoing review generation', 'Neighborhood landing pages', 'On-page and technical SEO'], featured: true },
        { name: 'Local Authority', price: '$2,500', cadence: '/mo', desc: 'For contractors who want to own the map across the Rockford metro.', features: ['Everything in Local Growth', 'Local link building', 'Seasonal demand targeting', 'Multi-area and service-area pages', 'AI search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does local SEO cost in Rockford?', a: "Most Rockford engagements land between $750 and $2,500 a month, depending on how many neighborhoods and keywords you're going after. Our tiers are right above this. No hidden fees, no long contract, and we confirm the exact scope in your free audit." },
      { q: 'How long until I show up in the Map Pack?', a: "Profile improvements can move in a few weeks. The competitive Rockford keywords usually take 90 to 180 days of steady work, because reviews and citations compound over time. Anyone promising you page one in 30 days is selling you something." },
      { q: 'What makes Rockford local SEO different?', a: "Two things. It's a value-conscious, buy-local market where homeowners actively prefer local contractors over chains, so trust signals like reviews and consistent listings carry real weight. And demand swings hard with the seasons — brutal winters, then spring tornadoes and Rock River flooding — so your ranking has to be in place before the spike, not after." },
      { q: 'How does local SEO help me during winter and storm season?', a: "When a deep freeze cracks pipes or a spring storm rolls through, searches for roofing, restoration, plumbing, and HVAC spike overnight, and the businesses already in the Map Pack take those calls. We get you ranking and reviewed ahead of season so you catch that demand instead of competing for scraps after everyone else is already booked." },
      { q: 'Which areas do you cover?', a: "All of the Rockford metro and the areas around it — Edgewater, Churchill's Grove, Signal Hill, Cherry Valley, Loves Park, Machesney Park, plus Belvidere, Roscoe, Rockton, Freeport and more. We build genuine neighborhood pages instead of one generic Rockford page, because that's what actually ranks for \"[service] [neighborhood]\" searches." },
      { q: 'Do you work with contractors specifically?', a: "It's basically all we do. Roofing, HVAC, plumbing, solar, electrical, restoration, and general contractors. We understand emergency calls, freeze and storm-driven demand, and insurance jobs, and we build your local SEO around them." },
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    problemHeading: "Three reasons your Rockford site isn't bringing in work",
    painPoints: [
      ...
      { title: "You're not ranking for the demand that matters", body: "Rockford demand swings hard with the seasons — winter freeze damage, then spring tornadoes and river flooding — and the contractors who rank for those terms ahead of time catch the spike. If your SEO ignores seasonal and storm-driven searches, you're leaving your busiest months on the table." },
    ],
    servicesHeading: 'The SEO work that actually moves rankings',
    services: [
      { name: 'Technical SEO', desc: "Crawlability, site speed, Core Web Vitals, schema, and the under-the-hood fixes Google needs before it will rank you at all." },
      { name: 'On-page optimization', desc: "Every important page tuned for the exact terms your Rockford customers search — titles, headings, content, and internal links." },
      { name: 'Content that ranks', desc: "Genuinely useful pages and articles that answer what buyers search, earn links, and bring in leads on autopilot." },
      { name: 'Link building', desc: "Authority from real Rockford and industry sources. In a competitive market, links are often what separate page one from page two." },
      ...
      { name: 'Seasonal SEO', desc: "We rank you for the freeze-driven, storm-driven, and seasonal searches that drive Rockford's busiest months, so you're visible before demand spikes, not after.", featured: true },
      { name: 'AI search & GEO', desc: "We structure your content so AI Overviews, ChatGPT, and Perplexity surface and cite you, where a growing share of search now begins.", featured: true },
    ],
    processName: 'How we work: the OnwardCraft SEO method',
    process: [
      { name: 'Audit and strategy', desc: "We benchmark your rankings, traffic, and competitors, then build a roadmap around the keywords most likely to drive real Rockford leads." },
      { name: 'Fix the technical base', desc: "Speed, crawlability, schema, and mobile — the foundation everything else needs to rank." },
      { name: 'Optimize and create content', desc: "On-page work across your money pages plus new local content, including the seasonal, freeze- and storm-driven terms that matter here." },
      { name: 'Build authority', desc: "Links and citations from trusted Rockford and industry sources to push competitive keywords onto page one." },
      { name: 'Report and scale', desc: "Monthly reporting tied to leads, then we double down on what's working and expand into the next keyword set." },
    ],
    pricing: {
      heading: 'Transparent Rockford SEO pricing',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'SEO Starter', price: '$900', cadence: '/mo', desc: 'For a focused site going after its core local keywords.', features: ['Technical SEO fixes', 'On-page optimization', 'Up to 5 target keywords', 'Google Business Profile', 'Monthly lead-tied report'] },
        { name: 'SEO Growth', price: '$1,800', cadence: '/mo', desc: 'For contractors competing across services and neighborhoods.', features: ['Everything in SEO Starter', 'Up to 12 target keywords', 'Monthly content', 'Link building', 'On-page + local SEO'], featured: true },
        { name: 'SEO Authority', price: '$3,000', cadence: '/mo', desc: 'For businesses that want to own Rockford search.', features: ['Everything in SEO Growth', 'Aggressive content + links', 'Seasonal SEO', 'eCommerce / multi-location', 'AI search / GEO optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does SEO cost in Rockford?', a: "Most Rockford SEO engagements run $900 to $3,000 a month, depending on how competitive your keywords are and how much content and link work you need. Our tiers are above, with no hidden fees and no long contract." },
      { q: 'How long does SEO take to work in Rockford?', a: "Expect early movement in 2 to 3 months and meaningful results in 4 to 6, faster on low-competition terms and slower on the most competitive Rockford keywords. SEO compounds, so the gains keep building the longer you run it." },
      ...
      { q: 'Should my Rockford SEO target winter and storm season?', a: "Yes. When a deep freeze cracks pipes or a spring storm hits, searches for roofing, restoration, plumbing, and HVAC spike overnight, and ranking takes months to build — so you have to be in place before the season, not chasing it after. We optimize for those seasonal and storm-driven terms ahead of time so your busiest months land on you." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    painPoints: [
      ...
      { title: "It's too slow on a phone", body: "Most of your Rockford visitors are on mobile, and they bounce if your site takes more than a few seconds to load. Slow sites also rank worse. We build fast, so you keep the visitor and the ranking." },
      { title: "It can't handle a seasonal surge", body: "After a hard freeze or a spring storm, contractor sites get hit with a flood of traffic, and the slow ones buckle or bury the call button right when it matters most. We build sites that stay fast and convert under load, so you capture that demand instead of losing it." },
    ],
    servicesHeading: "What's in an OnwardCraft Rockford website",
    services: [
      ...
      { name: 'Mobile-first build', desc: "Designed for the phone first, because that's where almost all of your Rockford traffic is. Fast, thumb-friendly, easy to call from." },
      { name: 'Conversion-focused UX', desc: "Clear offers, obvious call buttons, and lead forms placed where they actually get used. Every page has a next step." },
      { name: 'Copy that sells', desc: "Words that speak to practical, value-conscious homeowners and book the job, not filler text that reads like everyone else." },
      ...
      { name: 'Season-surge ready', desc: "Built to stay fast and keep the call button front and center when winter or storm-season traffic spikes — the moment that turns visitors into your biggest jobs.", featured: true },
    ...
    pricing: {
      heading: 'Transparent Rockford web design pricing',
      note: 'One-time build. 50% to start, 50% at launch. You own everything. No lock-in.',
      tiers: [
        { name: 'Starter Site', price: '$2,000', cadence: '', desc: 'A focused, high-converting site for a single-trade contractor.', features: ['Up to 5 custom pages', 'Mobile-first design', 'Lead forms + call buttons', 'Local SEO foundation', 'You own the site'] },
        { name: 'Growth Site', price: '$4,500', cadence: '', desc: 'A bigger site for established contractors with several services.', features: ['Up to 12 pages', 'Custom design + copywriting', 'Service + neighborhood pages', 'Speed & Core Web Vitals', 'Season-surge ready'], featured: true },
        { name: 'Custom Build', price: '$8,000', cadence: '', desc: 'A full custom build for multi-service or multi-location businesses.', features: ['Fully custom design', 'Advanced SEO + schema', 'Integrations & booking', 'High-traffic performance', 'AI-search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does a website cost in Rockford?', a: "Most contractor websites with us run $2,000 to $8,000 as a one-time build, depending on page count and integrations. Our tiers are above — fixed price, no surprises, and you own the finished site." },
      { q: 'How long does it take to build?', a: "A focused site takes about 2 to 4 weeks; a larger custom build takes 4 to 8. We give you a firm timeline up front and keep you updated through each stage." },
      { q: 'Will my site handle a seasonal traffic spike?', a: "Yes, and in Rockford that matters. After a hard freeze or a spring storm, contractor sites take a flood of traffic, and the slow ones lose leads right when demand peaks. We build fast and keep the call button obvious, so your site converts under load instead of buckling." },
      { q: 'Will my new site actually rank on Google?', a: "We build every site on a local-SEO foundation — fast load, clean structure, schema, and neighborhood-ready pages. The build gets you ready to rank; pairing it with our SEO service is how you climb the competitive Rockford terms." },
      { q: 'Do I own the website?', a: "Completely. You own the site, the domain, and the content. No hostage situations, no platforms you can't leave." },
      { q: 'Will it work well on phones?', a: "We design mobile-first, because that's where almost all of your Rockford traffic comes from. Fast load, easy-to-tap call buttons, and forms built for a thumb." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    problemHeading: "Signs your Rockford site is overdue for a redesign",
    painPoints: [
      ...
      { title: "It's slow and hard to use on a phone", body: "If your site is clunky or slow on mobile, you're losing the majority of your Rockford visitors before they ever see your offer. A redesign built mobile-first wins them back." },
      { title: "It can't keep up when demand surges", body: "Traffic that doesn't turn into calls is wasted — and an old site that gets slow under a winter or storm-season surge loses leads at the exact moment they're worth the most. We rebuild for conversions and for the days your phone should be ringing off the hook." },
    ],
    ...
    services: [
      ...
      { name: 'Mobile-first rebuild', desc: "Redesigned around the phone, where almost all your Rockford traffic lives." },
      { name: 'Brand refresh', desc: "A modern, trustworthy look that matches the quality of your work and the price of your jobs." },
      { name: 'Season-surge ready rebuild', desc: "Rebuilt to stay fast and keep converting when winter or storm-season traffic spikes, so the new site captures your biggest jobs instead of choking on them.", featured: true },
    ...
    pricing: {
      heading: 'Transparent Rockford redesign pricing',
      note: 'One-time project. 50% to start, 50% at launch. You own everything. No lock-in.',
      tiers: [
        { name: 'Redesign Starter', price: '$2,500', cadence: '', desc: 'A focused redesign for a small contractor site.', features: ['Up to 5 pages rebuilt', 'Mobile-first redesign', 'SEO-safe migration', 'Conversion improvements', 'You own the site'] },
        { name: 'Redesign Growth', price: '$5,000', cadence: '', desc: 'A full redesign for an established contractor site.', features: ['Up to 12 pages', 'Custom design + copy refresh', 'Speed overhaul', 'Service + neighborhood pages', 'Season-surge ready'], featured: true },
        { name: 'Full Rebuild', price: '$9,000', cadence: '', desc: 'A complete rebuild for multi-service or multi-location sites.', features: ['Full custom rebuild', 'Advanced SEO migration', 'Integrations & booking', 'High-traffic performance', 'AI-search optimization'] },
      ],
    },
    faqs: [
      { q: 'How much does a website redesign cost in Rockford?', a: "Most redesigns with us run $2,500 to $9,000 as a one-time project, depending on size and integrations. Fixed price, no surprises, and you own the result." },
      { q: 'Will I lose my Google rankings if I redesign?', a: "Not if it's done carefully, and that's exactly how we work. We map 301 redirects for every changed URL, preserve content and metadata, migrate your schema, and test on staging first. Done right, a redesign holds your rankings and usually improves them." },
      { q: 'How long does a redesign take?', a: "A focused redesign takes about 3 to 5 weeks; a larger rebuild takes 5 to 9. You get a firm timeline up front and updates at each stage." },
      { q: 'How do I know I need a redesign?', a: "If your site is slow on phones, looks dated, is hard to update, isn't bringing in leads, or buckles when winter or storm-season traffic surges, it's costing you work. The free audit tells you plainly whether a redesign is worth it." },
      { q: 'Do you migrate my existing content?', a: "Yes. We carry over and improve your existing content, preserve what's ranking, and handle the technical migration so nothing important gets lost." },
      { q: 'Will the new site handle seasonal traffic?', a: "Yes, and in Rockford that's a real consideration. After a hard freeze or a spring storm, contractor sites take a surge of traffic, and the slow ones lose leads. We rebuild for speed and keep the call to action obvious so the site converts when demand peaks." },
...
export const rockfordCity = {
  ...
  services: [
    {
      ...
      blurb: "Get into the top three businesses Google pins to the map when Rockford searches \"near me.\" The single highest-return move for most local businesses — and how you catch winter and storm-season demand.",
    },
    {
    ...
    },
    {
      ...
      blurb: "Fast, mobile-first websites engineered to turn visitors into booked jobs — and to stay fast when winter or storm season floods your phone — not brochures that just sit there.",
    },
    {
  ...
  faqs: [
    { q: 'What marketing services do you offer in Rockford?', a: "Four core services for contractors: web design, website redesign, SEO, and local SEO. Most clients combine a high-converting website with SEO and local SEO so they rank, convert, and own their leads — and are ready when winter and storm season hit." },
    { q: 'Do you work only with contractors?', a: "Almost entirely. We specialize in home-service trades — roofing, HVAC, plumbing, solar, electrical, restoration, and general contractors — so we understand emergency calls, freeze and storm-driven demand, and insurance work." },
