// FRESNO: per-metro x per-service local landing pages + city hub.
...
const MARKET = {
  ...
  stats: [
    ...
    { value: '~49%', label: 'of Fresno residents identify as Hispanic, so Spanish search is half the market', accent: true },
...
const WHY = [
  ...
  },
  {
    ...
    body: "Our prices are posted, every report ties back to leads you can count, and you go month-to-month once the first 90 days are up. If the work stops paying for itself in Fresno, you cut us loose. We carry the risk, not you.",
  },
];
...
const PROOF = {
  ...
  body:
    "A lot of agencies open with a grid of client logos. We are a young, founder-led shop in the San Joaquin Valley, and we are not going to invent a track record we have not earned yet. What we can put in front of you is the reasoning, taken straight from Google's and the industry's research on how Fresno homeowners actually search for a contractor.",
  stats: [
...
export const fresnoLocations = [
  // ─────────────────────────────────────────────────────────── LOCAL SEO ──
  {
    ...
    aioAnswer:
      "You rank by getting four things right: a Google Business Profile optimized for the exact services and neighborhoods you want; consistent name, address, and phone listings across the web; a steady stream of real reviews; and local content tied to real Fresno neighborhoods like Clovis, Fig Garden, and the Tower District. Fresno's market is heavily Hispanic, with nearly half of residents in that group, so the contractors who optimize for Spanish-language searches are reaching demand most competitors never touch. Seasonal targeting for extreme summer heat (May–Sep) and wildfire smoke filtration (Aug–Oct) also accelerates ranking during the periods that matter most.",
    problemHeading: "If your phone is quiet, it's usually one of these three",
    painPoints: [
      { title: 'Your competitors hold all three Fresno and Clovis map pins', body: "Search your own service plus \"near me\" right now. See those three businesses Google pins to the map? They get the overwhelming majority of the clicks, and in a market where AC failure in July is a genuine health emergency, whoever owns that top three gets the panic call. If you're not one of them, it almost doesn't matter how good your work is. Getting into that top three for Fresno and Clovis is usually the single highest-return move you can make." },
    ...
    services: [
      ...
      { name: 'Citations and NAP cleanup', desc: "Your name, address, and phone have to read the same everywhere Google checks, including the bilingual directories Fresno searchers use. We reconcile the listings that disagree and add the ones you never had." },
      { name: 'Reviews that keep coming', desc: "A simple system that turns finished jobs into a steady run of reviews, in English and Spanish. It lifts your ranking and gives the next homeowner a reason to call you when the AC quits at 108 degrees." },
      ...
      { name: 'On-page and technical SEO', desc: "Titles, schema, internal links, mobile speed. This is the wiring beneath the surface that lets every other piece of the work climb." },
      ...
      { name: 'Spanish-language reach', desc: "Nearly half of Fresno residents search in Spanish. We help you show up for that demand across Google Business Profile, content, and local listings, so you're reaching the market most of your competitors never see.", featured: true },
      { name: 'AI search readiness', desc: "A growing share of \"near me\" research now begins in AI Overviews, ChatGPT, and Perplexity, and people ask those tools in Spanish too. We structure your content so they can read your business and name it in the answer.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Fix the foundation', desc: "Google Business Profile and NAP come first, since they shift the quickest. Most Fresno clients notice early lift here inside the first few weeks." },
      { name: 'Build trust signals', desc: "Citations and the review engine go live. They stack up week over week, which is why local SEO pays the contractors who start before May, not the ones who wait until the first 105-degree afternoon." },
      ...
      { name: 'Report and expand', desc: "Reporting in plain language, tied to the calls and leads that came in, never vanity rankings. Then we move on to claim the next neighborhood." },
    ],
    pricing: {
      heading: 'Pricing you can read up front',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'Local Starter', price: '$750', cadence: '/mo', desc: 'One location, getting your Map Pack footing solid in Fresno.', features: ['Google Business Profile optimization', 'Citation cleanup and core listings', 'One location or primary service area', 'Review system setup', 'Plain-English monthly report'] },
        ...
        { name: 'Local Authority', price: '$2,500', cadence: '/mo', desc: 'For contractors who want the whole Valley map to themselves.', features: ['Everything in Local Growth', 'Local link building', 'Spanish-language search targeting', 'Multi-area and service-area pages', 'AI search optimization'] },
      ],
    },
    faqs: [
  ...
  // ───────────────────────────────────────────────────────── SEO SERVICES ──
  {
    ...
    services: [
      { name: 'Technical SEO', desc: "Crawlability, site speed, Core Web Vitals, schema, and the behind-the-scenes fixes Google wants settled before it will rank you for anything in the Valley." },
      ...
      { name: 'Link building', desc: "Authority from real Fresno, Clovis, and San Joaquin Valley sources Google trusts. In a growing market, links are often what separate the first page from the second." },
      ...
      { name: 'Revenue-tied reporting', desc: "We report on the calls, forms, and booked leads that came in, not just rankings and raw traffic, so you can always see what your SEO is putting in the bank." },
      ...
      { name: 'AI search & GEO', desc: "We structure your content so AI Overviews, ChatGPT, and Perplexity pull you into their answers, in English and in Spanish, where a growing share of Fresno search now starts.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Fix the technical base', desc: "Speed, crawlability, schema, and mobile, the groundwork every other piece of the work has to stand on before it can rank." },
      ...
      { name: 'Report and scale', desc: "Monthly reporting tied to leads, then we pour more into whatever is converting and push into the next set of Fresno keywords." },
    ],
    pricing: {
      heading: 'Transparent Fresno SEO pricing',
      note: 'Month-to-month after the first 90 days. No lock-in. Cancel whenever.',
      tiers: [
        { name: 'SEO Starter', price: '$900', cadence: '/mo', desc: 'For a focused site chasing its core Fresno keywords.', features: ['Technical SEO fixes', 'On-page optimization', 'Up to 5 target keywords', 'Google Business Profile', 'Monthly lead-tied report'] },
    ...
    faqs: [
      ...
      { q: 'Do you require a long-term contract?', a: "No. We ask for a first 90 days because SEO needs about that long to show real movement, and then you are month-to-month. If the leads are not showing up, you leave." },
  ...
  // ─────────────────────────────────────────────────────────── WEB DESIGN ──
  {
    ...
    services: [
      ...
      { name: 'Conversion-focused UX', desc: "Clear offers, call buttons you cannot miss, and lead forms set where a Fresno homeowner actually fills them out. Every page points to one obvious next step." },
      ...
      { name: 'Speed & Core Web Vitals', desc: "Tuned to load fast and clear Google's performance checks, which guards your conversions and your rankings at the same time, even on a phone baking on a Fresno dashboard." },
      ...
      { name: 'AI-search ready', desc: "Built so AI Overviews and ChatGPT can read your site and put your business in the answer, in either language, as more Fresno search moves to AI.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Design', desc: "We design a custom, mobile-first layout aimed at booking Fresno jobs, and you review and shape it before we write any code at all." },
      ...
      { name: 'Launch', desc: "We launch cleanly, with the SEO foundation, tracking, and speed all tuned from the first day it goes live." },
      { name: 'Support and optimize', desc: "We keep it quick and current and adjust it based on which pages are actually booking Fresno jobs." },
    ],
    pricing: {
      heading: 'Transparent Fresno web design pricing',
      note: 'One-time build. 50% to start, 50% at launch. You own everything. No lock-in.',
      tiers: [
        { name: 'Starter Site', price: '$2,000', cadence: '', desc: 'A tight, high-converting site for a single-trade Fresno contractor.', features: ['Up to 5 custom pages', 'Mobile-first design', 'Lead forms + call buttons', 'Local SEO foundation', 'You own the site'] },
        { name: 'Growth Site', price: '$4,500', cadence: '', desc: 'A larger site for established contractors running several services.', features: ['Up to 12 pages', 'Custom design + copywriting', 'Service + neighborhood pages', 'Speed & Core Web Vitals', 'Spanish-language reach'], featured: true },
    ...
    faqs: [
      { q: 'How much does a website cost in Fresno?', a: "Most contractor websites with us land between $2,000 and $8,000 as a one-time build, depending on page count and integrations. The price is fixed, there are no surprises, and the finished site belongs to you." },
      { q: 'How long does it take to build?', a: "A tight site runs about 2 to 4 weeks; a larger custom build runs 4 to 8. You get a firm timeline at the start and a check-in at every stage along the way." },
      ...
      { q: 'Do I own the website?', a: "All of it. The site, the domain, and the content are yours. No hostage situations and no platform you cannot walk away from." },
  ...
  // ────────────────────────────────────────────────────── WEBSITE REDESIGN ──
  {
    ...
    services: [
      { name: 'Redesign audit', desc: "We nail down exactly what is bleeding leads and rankings today, so the redesign solves the real Fresno problems instead of just repainting the colors." },
      ...
      { name: 'Conversion redesign', desc: "Clear offers, smarter call-to-action placement, and lead forms a busy Fresno homeowner will actually fill out. We design for booked jobs, not just a nicer screenshot." },
      { name: 'Speed overhaul', desc: "We rebuild for fast load and passing Core Web Vitals, which is critical when someone searches in an emergency and won't wait for a slow site." },
      ...
      { name: 'AI-search ready', desc: "Built so AI Overviews and ChatGPT can read your site and recommend you, in English and Spanish, as more Fresno search shifts toward AI.", featured: true },
    ],
    ...
    process: [
      ...
      { name: 'Design', desc: "A modern, mobile-first, conversion-focused design that you review and shape before we build any of it." },
      { name: 'Rebuild and migrate', desc: "We rebuild fast, add Spanish-language reach, and line up every redirect and SEO detail for a clean migration." },
      { name: 'Launch with SEO care', desc: "We launch with the redirects in place and watch closely so your Fresno rankings hold and climb instead of slipping." },
      { name: 'Optimize', desc: "Post-launch tuning based on which pages are converting, plus ongoing speed work and updates." },
    ],
    pricing: {
      heading: 'Transparent Fresno redesign pricing',
      note: 'One-time project. 50% to start, 50% at launch. You own everything. No lock-in.',
      tiers: [
        { name: 'Redesign Starter', price: '$2,500', cadence: '', desc: 'A tight redesign for a small Fresno contractor site.', features: ['Up to 5 pages rebuilt', 'Mobile-first redesign', 'SEO-safe migration', 'Conversion improvements', 'You own the site'] },
    ...
    faqs: [
      { q: 'How much does a website redesign cost in Fresno?', a: "Most redesigns with us land between $2,500 and $9,000 as a one-time project, depending on size and integrations. The price is fixed, there are no surprises, and the result is yours." },
      ...
      { q: 'How long does a redesign take?', a: "A tight redesign runs about 3 to 5 weeks; a larger rebuild runs 5 to 9. You get a firm timeline at the start and an update at every stage." },
...
export const fresnoCity = {
  ...
  services: [
    ...
    {
      service: 'Website Redesign', serviceSlug: 'website-redesign', tagline: 'More leads, same rankings',
  ...
  faqs: [
    ...
    { q: 'Do you work only with contractors?', a: "Almost entirely. We specialize in home-service trades like HVAC, roofing, plumbing, solar, electrical, restoration, and general contractors, so we understand summer AC emergencies, wildfire smoke filtration demand, and the unique dual market of urban homeowners and rural farm properties in the Fresno area." },
